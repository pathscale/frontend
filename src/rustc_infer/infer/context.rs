...
use crate::rustc_type_ir::solve::TyOrConstInferVar;
use crate::rustc_type_ir::{TypeSuperFoldable, TypeVisitableExt};
...
impl<'tcx> crate::rustc_type_ir::InferCtxtLike for InferCtxt<'tcx> {
    ...
    fn get_solver_region_constraint(
        &self,
    ) -> crate::rustc_type_ir::region_constraint::RegionConstraint<TyCtxt<'tcx>> {
        self.get_solver_region_constraint().without_spans()
    }

    fn overwrite_solver_region_constraint(
        &self,
        constraint: crate::rustc_type_ir::region_constraint::RegionConstraint<TyCtxt<'tcx>>,
        span: Span,
    ) {
    ...
    fn enter_forall_with_empty_assumptions<T: TypeFoldable<TyCtxt<'tcx>>, U>(
        ...
        self.enter_forall(value, |value| {
            ...
            self.placeholder_assumptions_for_next_solver
                .borrow_mut()
                .insert(u, Some(crate::rustc_type_ir::region_constraint::Assumptions::empty()));
            f(value)
        })
    }
    ...
    fn register_solver_region_constraint(
        &self,
        c: crate::rustc_type_ir::region_constraint::RegionConstraint<TyCtxt<'tcx>>,
        span: Span,
    ) {
