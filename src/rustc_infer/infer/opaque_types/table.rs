...
use crate::bug;
use crate::rustc_middle::ty::{OpaqueTypeKey, ProvisionalHiddenType, Ty};
use tracing::instrument;

use crate::rustc_infer::infer::snapshot::undo_log::{InferCtxtUndoLogs, UndoLog};
...
impl crate::rustc_type_ir::inherent::OpaqueTypeStorageEntries for OpaqueTypeStorageEntries {
