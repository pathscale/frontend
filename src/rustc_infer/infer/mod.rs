...
use crate::rustc_data_structures::snapshot_vec as sv;
use crate::rustc_data_structures::undo_log::{Rollback, UndoLogs};
use crate::rustc_data_structures::unify::{self as ut, UnifyKey, UnifyValue};
...
use crate::rustc_type_ir::{CanonicalizerState, MayBeErased};
use snapshot::undo_log::InferCtxtUndoLogs;
use tracing::{debug, instrument};
use ty::solve::TyOrConstInferVar;
use type_variable::TypeVariableOrigin;

use crate::rustc_infer::infer::snapshot::undo_log::UndoLog;
use crate::rustc_infer::infer::type_variable::{FloatVariableOrigin, TypeVariableValue};
use crate::rustc_infer::infer::unify_key::{ConstVariableOrigin, ConstVariableValue, ConstVidKey};
...
pub struct InferCtxt<'tcx> {
    ...
    placeholder_assumptions_for_next_solver: RefCell<
        FxIndexMap<
            ty::UniverseIndex,
            Option<crate::rustc_type_ir::region_constraint::Assumptions<TyCtxt<'tcx>>>,
        >,
    >,
...
crate::static_assert_size!(SubregionOrigin<'_>, 32);
...
impl<'tcx> InferCtxt<'tcx> {
    ...
    /// the [`CantBeErased`](crate::rustc_type_ir::CantBeErased) enum. That way you don't even have to
    ...
    pub fn insert_placeholder_assumptions(
        &self,
        u: ty::UniverseIndex,
        assumptions: Option<crate::rustc_type_ir::region_constraint::Assumptions<TyCtxt<'tcx>>>,
    ) {
