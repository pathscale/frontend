...
impl<C> DebugWithContext<C> for crate::rustc_mir_dataflow::move_paths::InitIndex {}

impl<'tcx, C> DebugWithContext<C> for crate::rustc_mir_dataflow::move_paths::MovePathIndex
where
