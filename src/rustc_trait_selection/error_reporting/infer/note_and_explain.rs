...
use crate::rustc_errors::Applicability::{MachineApplicable, MaybeIncorrect};
use crate::rustc_errors::{Diag, MultiSpan, pluralize};
...
```
impl<T: core::default::Default> Trait<T> for X {
    fn foo(&self) -> T { <T as core::default::Default>::default() }
}
```
