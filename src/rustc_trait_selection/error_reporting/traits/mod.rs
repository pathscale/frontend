...
use crate::rustc_errors::{Applicability, Diag, E0038, E0276, MultiSpan, struct_span_code_err};
...
use crate::rustc_middle::ty::{self, Ty, TyCtxt, TypeVisitableExt as _};
use crate::rustc_next_trait_solver::solve::TyOrConstInferVar;
use crate::rustc_span::{DesugaringKind, ErrorGuaranteed, ExpnKind, Span};
use thin_vec::ThinVec;
use tracing::{info, instrument};

pub use self::overflow::*;
use crate::rustc_trait_selection::error_reporting::TypeErrCtxt;
use crate::rustc_trait_selection::traits::{FulfillmentError, FulfillmentErrorCode};
...
impl<'a, 'tcx> TypeErrCtxt<'a, 'tcx> {
    ...
    fn report_fulfillment_error(
        ...
        if matches!(
            error.code,
            FulfillmentErrorCode::Select(crate::rustc_trait_selection::traits::SelectionError::Unimplemented)
