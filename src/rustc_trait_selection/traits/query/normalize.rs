...
use crate::rustc_trait_selection::error_reporting::traits::OverflowCause;
use crate::rustc_trait_selection::infer::at::At;
use crate::rustc_trait_selection::infer::canonical::OriginalQueryValues;
use crate::rustc_trait_selection::infer::{InferCtxt, InferOk};
use crate::rustc_trait_selection::traits::normalize::needs_normalization;
...
impl<'a, 'tcx> At<'a, 'tcx> {
        ...
        T: TypeFoldable<TyCtxt<'tcx>>,
    {
        ...
        if self.infcx.next_trait_solver() {
            match crate::rustc_trait_selection::solve::deeply_normalize_with_skipped_universes::<_, ScrubbedTraitError<'tcx>>(
                self,
...
impl<'a, 'tcx> FallibleTypeFolder<TyCtxt<'tcx>> for QueryNormalizer<'a, 'tcx> {
    ...
    fn try_fold_const(
        ...
        let constant = match alias_const.kind {
            ty::AliasConstKind::Anon { .. } => crate::rustc_trait_selection::traits::with_replaced_escaping_bound_vars(
                self.infcx,
                &mut self.universes,
                constant,
                |constant| crate::rustc_trait_selection::traits::evaluate_const(&self.infcx, constant, self.param_env),
            ),
