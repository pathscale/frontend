...
use crate::rustc_infer::infer::canonical::{CanonicalQueryInput, CanonicalQueryResponse};
...
use crate::rustc_middle::ty::{self, ParamEnvAnd, Ty, TyCtxt, TypeVisitable, TypeVisitor, Unnormalized};
use crate::rustc_span::def_id::CRATE_DEF_ID;
use crate::rustc_span::{DUMMY_SP, Span, sym};
use smallvec::{SmallVec, smallvec};

use crate::rustc_trait_selection::traits::query::NoSolution;
use crate::rustc_trait_selection::traits::query::type_op::QueryTypeOp;
use crate::rustc_trait_selection::traits::{ObligationCtxt, wf};
