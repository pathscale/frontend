...
use crate::rustc_lint_defs::builtin::COHERENCE_LEAK_CHECK;
use crate::bug;
...
use crate::rustc_trait_selection::diagnostics::NegativePositiveConflict;
use crate::rustc_trait_selection::error_reporting::traits::to_pretty_impl_header;
use crate::rustc_trait_selection::infer::{InferCtxt, TyCtxtInferExt};
    ...
    match used_to_be_allowed {
        ...
        Some(kind) => {
            ...
            tcx.emit_node_span_lint(
                ...
                impl_span,
                crate::rustc_errors::DiagDecorator(|err| {
