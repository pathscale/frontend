...
use crate::rustc_trait_selection::infer::outlives::test_type_match;
use crate::rustc_trait_selection::infer::region_constraints::VerifyIfEq;
use crate::rustc_trait_selection::regions::{region_known_to_outlive, ty_known_to_outlive};
...
pub(crate) fn args_known_to_outlive_opaque_params<'tcx>(
    ...
    let (parent_def_id, wf_tys) = match tcx.opaque_ty_origin(def_id) {
        crate::rustc_hir::OpaqueTyOrigin::FnReturn { parent, .. }
        | crate::rustc_hir::OpaqueTyOrigin::AsyncFn { parent, .. }
        | crate::rustc_hir::OpaqueTyOrigin::TyAlias { parent, .. } => {
