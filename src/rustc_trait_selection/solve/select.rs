...
use crate::rustc_trait_selection::solve::inspect::{self, InferCtxtProofTreeExt};

#[extension(pub trait InferCtxtSelectExt<'tcx>)]
impl<'tcx> InferCtxt<'tcx> {
    /// Do not use this directly. This is called from [`crate::rustc_trait_selection::traits::SelectionContext::select`].
