...
use crate::rustc_trait_selection::infer::at::ToTrace;
use crate::rustc_trait_selection::traits::query::evaluate_obligation::InferCtxtExt as _;
use crate::rustc_trait_selection::traits::{self, Obligation, ObligationCause, ObligationCtxt};
...
impl<'tcx> InferCtxt<'tcx> {
    ...
    /// [`evaluate_obligation`]: crate::rustc_trait_selection::traits::query::evaluate_obligation::InferCtxtExt::evaluate_obligation
    /// [`predicate_must_hold_modulo_regions`]: crate::rustc_trait_selection::traits::query::evaluate_obligation::InferCtxtExt::predicate_must_hold_modulo_regions
    /// [`Binder`]: ty::Binder
