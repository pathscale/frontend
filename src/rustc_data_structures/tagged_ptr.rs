...
use crate::rustc_data_structures::aligned::Aligned;
...
pub const fn bits_for<T: ?Sized + Aligned>() -> u32 {
    let alignment = crate::rustc_data_structures::aligned::align_of::<T>();
    ...
    T: Tag,
{
    ...
    ///
    /// [`TaggedRef`]: crate::rustc_data_structures::tagged_ptr::TaggedRef
    #[inline]
