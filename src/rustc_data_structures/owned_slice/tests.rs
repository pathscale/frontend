...
use crate::rustc_data_structures::owned_slice::{OwnedSlice, slice_owned, try_slice_owned};
...
#[test]
fn send_sync() {
    crate::rustc_data_structures::sync::assert_dyn_send::<OwnedSlice>();
    crate::rustc_data_structures::sync::assert_dyn_sync::<OwnedSlice>();
}
