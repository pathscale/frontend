...
use crate::rustc_data_structures::fx::{FxBuildHasher, FxHashMap, FxHashSet};
...
impl<K: Eq + Hash, V> UnordMap<K, V> {
    ...
    #[inline]
    pub fn try_insert(&mut self, k: K, v: V) -> Result<&mut V, OccupiedError<'_, K, V, FxBuildHasher>> {
    ...
    #[inline]
    pub fn entry(&mut self, key: K) -> Entry<'_, K, V, FxBuildHasher> {
