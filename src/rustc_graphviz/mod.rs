...
// Renders dot output through `io::Write`, which is a real std facility and the whole
// purpose of the crate. It goes when graph dumping does, not before.
...
pub fn render<'a, N, E, G, W>(g: &'a G, w: &mut W) -> fmt::Result
where
    N: Clone + 'a,
    E: Clone + 'a,
...
pub fn render_opts<'a, N, E, G, W>(g: &'a G, w: &mut W, options: &[RenderOption]) -> fmt::Result
where
    N: Clone + 'a,
    E: Clone + 'a,
    G: Labeller<'a, Node = N, Edge = E> + GraphWalk<'a, Node = N, Edge = E>,
