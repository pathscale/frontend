...
/// `core::cmp::PartialEq`. It's represented as a sequence of identifiers,
...
impl FnDeclFlags {
    ...
    /// Must have the same value as `FnSigKind::NO_SPLATTED_ARG_INDEX` and `crate::rustc_ast::FnDecl::NO_SPLATTED_ARG_INDEX`.
