...
impl Arch {
    ...
    pub(crate) fn target_arch(self) -> crate::rustc_target::spec::Arch {
        match self {
            Self::Armv7k | Self::Armv7s => crate::rustc_target::spec::Arch::Arm,
            Self::Arm64 | Self::Arm64e | Self::Arm64_32 => crate::rustc_target::spec::Arch::AArch64,
            Self::I386 | Self::I686 => crate::rustc_target::spec::Arch::X86,
            Self::X86_64 | Self::X86_64h => crate::rustc_target::spec::Arch::X86_64,
        }
    }
...
pub(crate) fn base(
    ...
    arch: Arch,
    env: TargetEnv,
) -> (TargetOptions, StaticCow<str>, crate::rustc_target::spec::Arch) {
    let link_env_remove = link_env_remove(&os);
    let unversioned_llvm_target = unversioned_llvm_target(&os, arch, env);
    let mut opts = TargetOptions {
        llvm_floatabi: if arch.target_arch() == crate::rustc_target::spec::Arch::Arm {
            Some(FloatAbi::Hard)
        } else {
...
impl OSVersion {
    ...
    pub fn minimum_deployment_target(target: &Target) -> Self {
        let (major, minor, patch) = match (&target.os, &target.arch, &target.env) {
            (Os::MacOs, crate::rustc_target::spec::Arch::AArch64, _) => (11, 0, 0),
            (Os::IOs, crate::rustc_target::spec::Arch::AArch64, Env::MacAbi) => (14, 0, 0),
            (Os::IOs, crate::rustc_target::spec::Arch::AArch64, Env::Sim) => (14, 0, 0),
            (Os::IOs, _, _) if target.llvm_target.starts_with("arm64e") => (14, 0, 0),
            // Mac Catalyst defaults to 13.1 in Clang.
            (Os::IOs, _, Env::MacAbi) => (13, 1, 0),
            (Os::TvOs, crate::rustc_target::spec::Arch::AArch64, Env::Sim) => (14, 0, 0),
            (Os::WatchOs, crate::rustc_target::spec::Arch::AArch64, Env::Sim) => (7, 0, 0),
            ...
            (Os::WatchOs, crate::rustc_target::spec::Arch::AArch64, Env::Unspecified)
