...
use crate::rustc_error_messages::{DiagArgValue, IntoDiagArg, into_diag_arg_using_display};
use rustc_macros::{BlobDecodable, Decodable, Encodable, StableHash};
use crate::rustc_span::{Symbol, kw, sym};
use serde_json::Value;
use tracing::debug;

use crate::rustc_target::json::{Json, ToJson};
...
pub use base::apple;
pub use crate::rustc_structures::SanitizerSet;
...
crate::rustc_target::target_spec_enum! {
    pub enum LldFlavor {
        Wasm = "wasm",
        Ld64 = "darwin",
        Ld = "gnu",
...
crate::rustc_target::json::serde_deserialize_from_str!(LinkerFlavorCli);
...
crate::rustc_target::json::serde_deserialize_from_str!(LinkSelfContainedDefault);
...
crate::external_bitflags_debug! { LinkSelfContainedComponents }
...
crate::rustc_target::json::serde_deserialize_from_str!(LinkSelfContainedComponents);
...
crate::external_bitflags_debug! { LinkerFeatures }
...
crate::rustc_target::json::serde_deserialize_from_str!(SmallDataThresholdSupport);
    ...
    ( $(($tuple:literal, $module:ident),)+ ) => {
        ...
        mod tests {
            ...
            $(
                #[test] // `#[test]`
                fn $module() {
                    crate::rustc_target::spec::targets::$module::target().test_target()
                }
            )+
        }
    };
...
impl Arch {
    pub fn desc_symbol(&self) -> Symbol {
        match self {
            ...
            Self::Other(name) => crate::rustc_span::Symbol::intern(name),
        }
    }
...
pub struct TargetOptions {
    ...
    /// `crate::rustc_session::Session::default_visibility` method, which allows `rustc` users to override
    ...
    pub default_address_space: crate::rustc_abi::AddressSpace,
...
impl Default for TargetOptions {
    ...
    fn default() -> TargetOptions {
        TargetOptions {
            ...
            supports_xray: false,
            default_address_space: crate::rustc_abi::AddressSpace::ZERO,
...
impl Target {
    ...
    pub fn search(
        ...
        fn load_file(
            ...
            let contents = file::read_to_string(path).map_err(|e| e.to_string())?;
