...
pub(super) fn regclass_map() -> crate::rustc_data_structures::fx::FxHashMap<
    super::InlineAsmRegClass,
    crate::rustc_data_structures::fx::FxIndexSet<super::InlineAsmReg>,
> {
...
impl AmdgpuInlineAsmRegClass {
    ...
    fn try_get_name(self) -> Option<crate::rustc_span::Symbol> {
        let s = match self {
            Self::Sgpr(32) => crate::rustc_span::sym::sgpr32,
            Self::Sgpr(64) => crate::rustc_span::sym::sgpr64,
            Self::Sgpr(96) => crate::rustc_span::sym::sgpr96,
            Self::Sgpr(128) => crate::rustc_span::sym::sgpr128,
            Self::Sgpr(256) => crate::rustc_span::sym::sgpr256,
            Self::Sgpr(512) => crate::rustc_span::sym::sgpr512,
            Self::Vgpr(16) => crate::rustc_span::sym::vgpr16,
            Self::Vgpr(32) => crate::rustc_span::sym::vgpr32,
            Self::Vgpr(64) => crate::rustc_span::sym::vgpr64,
            Self::Vgpr(96) => crate::rustc_span::sym::vgpr96,
            Self::Vgpr(128) => crate::rustc_span::sym::vgpr128,
            Self::Vgpr(160) => crate::rustc_span::sym::vgpr160,
            Self::Vgpr(192) => crate::rustc_span::sym::vgpr192,
            Self::Vgpr(224) => crate::rustc_span::sym::vgpr224,
            Self::Vgpr(256) => crate::rustc_span::sym::vgpr256,
            Self::Vgpr(288) => crate::rustc_span::sym::vgpr288,
            Self::Vgpr(320) => crate::rustc_span::sym::vgpr320,
            Self::Vgpr(352) => crate::rustc_span::sym::vgpr352,
            Self::Vgpr(384) => crate::rustc_span::sym::vgpr384,
            Self::Vgpr(512) => crate::rustc_span::sym::vgpr512,
            Self::Vgpr(1024) => crate::rustc_span::sym::vgpr1024,
            _ => return None,
        };
        Some(s)
    }

    pub fn name(self) -> crate::rustc_span::Symbol {
        self.try_get_name().expect("Invalid amdgpu register class")
    }

    pub fn parse(name: crate::rustc_span::Symbol) -> Result<Self, &'static [crate::rustc_span::Symbol]> {
        match name {
            crate::rustc_span::sym::sgpr32 => Ok(Self::Sgpr(32)),
            crate::rustc_span::sym::sgpr64 => Ok(Self::Sgpr(64)),
            crate::rustc_span::sym::sgpr96 => Ok(Self::Sgpr(96)),
            crate::rustc_span::sym::sgpr128 => Ok(Self::Sgpr(128)),
            crate::rustc_span::sym::sgpr256 => Ok(Self::Sgpr(256)),
            crate::rustc_span::sym::sgpr512 => Ok(Self::Sgpr(512)),
            crate::rustc_span::sym::vgpr16 => Ok(Self::Vgpr(16)),
            crate::rustc_span::sym::vgpr32 => Ok(Self::Vgpr(32)),
            crate::rustc_span::sym::vgpr64 => Ok(Self::Vgpr(64)),
            crate::rustc_span::sym::vgpr96 => Ok(Self::Vgpr(96)),
            crate::rustc_span::sym::vgpr128 => Ok(Self::Vgpr(128)),
            crate::rustc_span::sym::vgpr160 => Ok(Self::Vgpr(160)),
            crate::rustc_span::sym::vgpr192 => Ok(Self::Vgpr(192)),
            crate::rustc_span::sym::vgpr224 => Ok(Self::Vgpr(224)),
            crate::rustc_span::sym::vgpr256 => Ok(Self::Vgpr(256)),
            crate::rustc_span::sym::vgpr288 => Ok(Self::Vgpr(288)),
            crate::rustc_span::sym::vgpr320 => Ok(Self::Vgpr(320)),
            crate::rustc_span::sym::vgpr352 => Ok(Self::Vgpr(352)),
            crate::rustc_span::sym::vgpr384 => Ok(Self::Vgpr(384)),
            crate::rustc_span::sym::vgpr512 => Ok(Self::Vgpr(512)),
            crate::rustc_span::sym::vgpr1024 => Ok(Self::Vgpr(1024)),
            _ => Err(&[
                crate::rustc_span::sym::sgpr32,
                crate::rustc_span::sym::sgpr64,
                crate::rustc_span::sym::sgpr96,
                crate::rustc_span::sym::sgpr128,
                crate::rustc_span::sym::sgpr256,
                crate::rustc_span::sym::sgpr512,
                crate::rustc_span::sym::vgpr16,
                crate::rustc_span::sym::vgpr32,
                crate::rustc_span::sym::vgpr64,
                crate::rustc_span::sym::vgpr96,
                crate::rustc_span::sym::vgpr128,
                crate::rustc_span::sym::vgpr160,
                crate::rustc_span::sym::vgpr192,
                crate::rustc_span::sym::vgpr224,
                crate::rustc_span::sym::vgpr256,
                crate::rustc_span::sym::vgpr288,
                crate::rustc_span::sym::vgpr320,
                crate::rustc_span::sym::vgpr352,
                crate::rustc_span::sym::vgpr384,
                crate::rustc_span::sym::vgpr512,
                crate::rustc_span::sym::vgpr1024,
            ]),
        }
    }
...
impl AmdgpuInlineAsmReg {
    ...
    pub fn validate(
        ...
        _reloc_model: crate::rustc_target::spec::RelocModel,
        _target_features: &crate::rustc_data_structures::fx::FxIndexSet<Symbol>,
...
pub(super) fn fill_reg_map(
    ...
    _target_features: &crate::rustc_data_structures::fx::FxIndexSet<Symbol>,
    _target: &crate::rustc_target::spec::Target,
    map: &mut crate::rustc_data_structures::fx::FxHashMap<
        super::InlineAsmRegClass,
        crate::rustc_data_structures::fx::FxIndexSet<super::InlineAsmReg>,
    >,
) {
