...
use eko::thread::LazyLock;
#[cfg(debug_assertions)]
use core::sync::atomic::{AtomicBool, Ordering};

use crate::rustc_ast::{AttrStyle, MetaItemLit, Safety};
use crate::rustc_attr_ir::target::Target;
use crate::rustc_attr_ir::{AttrPath, Attribute, AttributeKind};
...
use crate::rustc_lint_defs::{Lint, LintId};
use crate::rustc_parse::parser::Recovery;
use crate::rustc_session::Session;
use crate::rustc_span::{ErrorGuaranteed, Ident, Span, Symbol};

// Glob imports to avoid big, bitrotty import lists
use crate::rustc_attr_parsing::attributes::allow_unstable::*;
use crate::rustc_attr_parsing::attributes::autodiff::*;
use crate::rustc_attr_parsing::attributes::body::*;
use crate::rustc_attr_parsing::attributes::cfi_encoding::*;
use crate::rustc_attr_parsing::attributes::codegen_attrs::*;
use crate::rustc_attr_parsing::attributes::confusables::*;
use crate::rustc_attr_parsing::attributes::crate_level::*;
use crate::rustc_attr_parsing::attributes::debugger::*;
use crate::rustc_attr_parsing::attributes::deprecation::*;
use crate::rustc_attr_parsing::attributes::diagnostic::do_not_recommend::*;
use crate::rustc_attr_parsing::attributes::diagnostic::on_const::*;
use crate::rustc_attr_parsing::attributes::diagnostic::on_move::*;
use crate::rustc_attr_parsing::attributes::diagnostic::on_type_error::*;
use crate::rustc_attr_parsing::attributes::diagnostic::on_unimplemented::*;
use crate::rustc_attr_parsing::attributes::diagnostic::on_unknown::*;
use crate::rustc_attr_parsing::attributes::diagnostic::on_unmatched_args::*;
use crate::rustc_attr_parsing::attributes::diagnostic::opaque::*;
use crate::rustc_attr_parsing::attributes::doc::*;
use crate::rustc_attr_parsing::attributes::dummy::*;
use crate::rustc_attr_parsing::attributes::inline::*;
use crate::rustc_attr_parsing::attributes::instruction_set::*;
use crate::rustc_attr_parsing::attributes::link_attrs::*;
use crate::rustc_attr_parsing::attributes::lint_helpers::*;
use crate::rustc_attr_parsing::attributes::loop_match::*;
use crate::rustc_attr_parsing::attributes::macro_attrs::*;
use crate::rustc_attr_parsing::attributes::must_not_suspend::*;
use crate::rustc_attr_parsing::attributes::must_use::*;
use crate::rustc_attr_parsing::attributes::no_implicit_prelude::*;
use crate::rustc_attr_parsing::attributes::no_link::*;
use crate::rustc_attr_parsing::attributes::non_exhaustive::*;
use crate::rustc_attr_parsing::attributes::path::PathParser as PathAttributeParser;
use crate::rustc_attr_parsing::attributes::pin_v2::*;
use crate::rustc_attr_parsing::attributes::proc_macro_attrs::*;
use crate::rustc_attr_parsing::attributes::prototype::*;
use crate::rustc_attr_parsing::attributes::repr::*;
use crate::rustc_attr_parsing::attributes::rustc_allocator::*;
use crate::rustc_attr_parsing::attributes::rustc_dump::*;
use crate::rustc_attr_parsing::attributes::rustc_internal::*;
use crate::rustc_attr_parsing::attributes::semantics::{ComptimeParser, *};
use crate::rustc_attr_parsing::attributes::splat::*;
use crate::rustc_attr_parsing::attributes::stability::*;
use crate::rustc_attr_parsing::attributes::test_attrs::*;
use crate::rustc_attr_parsing::attributes::traits::*;
use crate::rustc_attr_parsing::attributes::transparency::*;
use crate::rustc_attr_parsing::attributes::unroll::*;
use crate::rustc_attr_parsing::attributes::{AttributeParser as _, AttributeSafety, Combine, Single, WithoutArgs};
...
use crate::rustc_attr_parsing::parser::{
...
use crate::rustc_attr_parsing::{AttributeParser, AttributeTemplate, EmitAttribute};
                        ...
                        match accepters.entry(*path) {
                            Entry::Vacant(e) => {
                                e.insert(GroupTypeInnerAccept {
                                    ...
                                    safety: <$names as crate::rustc_attr_parsing::attributes::AttributeParser>::SAFETY,
                                    stability: *stability,
                                    allowed_targets: <$names as crate::rustc_attr_parsing::attributes::AttributeParser>::ALLOWED_TARGETS,
                                    finalizer: |cx| {
...
impl<'f, 'sess: 'f> AcceptContext<'f, 'sess> {
    ...
    /// [`parser`][crate::rustc_attr_parsing::parser] module. You may still want to use the lower-level methods for the
    /// following reasons:
    ///
    /// - You want to emit your own diagnostics (for instance, with [`SharedContext::emit_err`]).
    /// - The attribute can be parsed in multiple ways and it does not make sense to emit an error.
...
///
/// Gives [`AttributeParser`](crate::rustc_attr_parsing::attributes::AttributeParser)s enough information to create
/// errors, for example.
...
pub(crate) struct FinalizeContext<'p, 'sess> {
    ...
    ///
    /// Useful for compatibility checks with other attributes in [`finalize`](crate::rustc_attr_parsing::attributes::AttributeParser::finalize)
    ///
...
impl<'a, 'f, 'sess: 'f> AttributeDiagnosticContext<'a, 'f, 'sess> {
    ...
    pub(crate) fn warn_empty_attribute(&mut self, span: Span) {
        ...
        self.emit_lint(
            UNUSED_ATTRIBUTES,
            crate::rustc_attr_parsing::diagnostics::EmptyAttributeList {
                attr_span: span,
                attr_path,
                valid_without_list,
            },
    ...
    pub(crate) fn warn_ill_formed_attribute_input_with_help(
        ...
        self.emit_lint(
            lint,
            crate::rustc_attr_parsing::diagnostics::IllFormedAttributeInput::new(&suggestions, None, help.as_deref()),
            span,
        );
    }
