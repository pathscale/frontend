...
use crate::rustc_attr_ir::AttrPath;
use crate::rustc_errors::{Applicability, Diag, PResult};
use crate::exp;
use crate::rustc_parse::parser::{ForceCollect, Parser, PathStyle, Recovery, token_descr};
use crate::rustc_session::diagnostics::create_lit_error;
...
///
/// [`AttributeDiagnosticContext`]: crate::rustc_attr_parsing::context::AttributeDiagnosticContext
#[derive(Debug)]
#[must_use]
pub enum ArgParser {
    NoArgs,
...
impl ArgParser {
    ...
    /// (to pass to [`AttributeDiagnosticContext::expected_no_args`](crate::rustc_attr_parsing::context::AttributeDiagnosticContext::expected_no_args)).
...
/// [`AcceptContext::expect_list`](crate::rustc_attr_parsing::context::AcceptContext::expect_list) and
/// [`AcceptContext::expect_single`](crate::rustc_attr_parsing::context::AcceptContext::expect_single) helpers.
