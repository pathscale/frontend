...
use crate::rustc_ast::ast::Safety;
use crate::rustc_span::Symbol;

use crate::rustc_attr_parsing::ParsedDescription;
...
macro_rules! template {
    ...
    (@ $word: expr, $list: expr, $one_of: expr, $name_value_str: expr, $link: expr) => { $crate::rustc_attr_parsing::AttributeTemplate {
