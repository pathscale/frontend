use alloc::boxed::Box;
use crate::rustc_ast::Safety;
use crate::rustc_attr_ir::AttrPath;
use crate::rustc_errors::{Diagnostic, MultiSpan};
use crate::rustc_lint_defs::LintId;
use crate::rustc_lint_defs::builtin::{UNSAFE_ATTR_OUTSIDE_UNSAFE, UNSAFE_CODE};
use crate::rustc_span::Span;

use crate::rustc_attr_parsing::attributes::AttributeSafety;
use crate::rustc_attr_parsing::{AttributeParser, EmitAttribute, ShouldEmit, diagnostics};
    ...
    pub fn check_attribute_safety(
        ...
        match (expected_safety, attr_safety) {
            ...
            (AttributeSafety::Unsafe { unsafe_since, note: _ }, Safety::Default) => {
                ...
                if emit_error {
                    self.emit_err(crate::rustc_attr_parsing::diagnostics::UnsafeAttrOutsideUnsafe {
                        span: path_span,
                        suggestion: not_from_proc_macro.then(|| {
                            crate::rustc_attr_parsing::diagnostics::UnsafeAttrOutsideUnsafeSuggestion {
            ...
            (AttributeSafety::Normal, Safety::Unsafe(unsafe_span)) => {
                self.emit_err(crate::rustc_attr_parsing::diagnostics::InvalidAttrUnsafe {
                    span: unsafe_span,
