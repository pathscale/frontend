...
use crate::rustc_errors::{Applicability, Diagnostic, PResult};
use crate::rustc_feature::BUILTIN_ATTRIBUTE_MAP;
use crate::rustc_lint_defs::builtin::ILL_FORMED_ATTRIBUTE_INPUT;
...
use crate::rustc_attr_parsing::{AttributeParser, AttributeTemplate, diagnostics as errors, template};
...
pub fn emit_malformed_attribute(
    ...
    if should_warn(name) {
        ...
        psess.dyn_buffer_lint(
            ...
            ast::CRATE_NODE_ID,
            move |dcx, level| {
                crate::rustc_attr_parsing::diagnostics::IllFormedAttributeInput::new(&suggestions, template.docs, None)
                    .into_diag(dcx, level)
            },
        );
    } else {
