...
use crate::rustc_ast::{AttrStyle, Safety};
use crate::rustc_attr_ir::target::{AssocCtxt, MethodKind, Target};
use crate::rustc_attr_ir::{AttrItem, Attribute, AttributeKind};
use crate::rustc_errors::{DiagArgValue, MultiSpan, StashKey};
...
use crate::rustc_span::{BytePos, FileName, RemapPathScopeComponents, Span, Symbol, sym};
...
impl<'sess> AttributeParser<'sess> {
    ...
    pub(crate) fn check_crate_level(cx: &mut AcceptContext<'_, 'sess>, warn: bool) {
        ...
        let diag = crate::rustc_attr_parsing::diagnostics::InvalidAttrStyle {
            name,
            is_used_as_inner,
...
pub(crate) const ALL_TARGETS: &[Policy] = {
    ...
    &[
        ...
        Allow(Target::GenericParam {
            kind: crate::rustc_attr_ir::target::GenericParamKind::Const,
            has_default: false,
        }),
        Allow(Target::GenericParam {
            kind: crate::rustc_attr_ir::target::GenericParamKind::Const,
        ...
        Allow(Target::GenericParam {
            kind: crate::rustc_attr_ir::target::GenericParamKind::Lifetime,
            has_default: false,
        }),
        Allow(Target::GenericParam {
            kind: crate::rustc_attr_ir::target::GenericParamKind::Lifetime,
        ...
        Allow(Target::GenericParam {
            kind: crate::rustc_attr_ir::target::GenericParamKind::Type,
            has_default: false,
        }),
        Allow(Target::GenericParam {
            kind: crate::rustc_attr_ir::target::GenericParamKind::Type,
