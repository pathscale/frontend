use crate::rustc_attr_ir::{MacroUseArgs, find_attr};
use crate::rustc_feature::AttributeStability;
use crate::rustc_lint_defs::builtin::INVALID_MACRO_EXPORT_ARGUMENTS;
use crate::rustc_structures::CollapseMacroDebuginfo;

use super::prelude::*;
use crate::rustc_attr_parsing::diagnostics::MacroOnlyAttribute;
