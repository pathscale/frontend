...
use crate::rustc_attr_ir::target::{MethodKind, Target};
use crate::rustc_attr_ir::{AttributeKind, RustcAutodiff};
use crate::rustc_feature::AttributeStability;
use crate::rustc_span::{Symbol, sym};
use thin_vec::ThinVec;

use crate::rustc_attr_parsing::attributes::SingleAttributeParser;
use crate::rustc_attr_parsing::attributes::prelude::Allow;
use crate::rustc_attr_parsing::context::AcceptContext;
use crate::rustc_attr_parsing::parser::{ArgParser, MetaItemOrLitParser};
use crate::rustc_attr_parsing::target_checking::AllowedTargets;
use crate::rustc_attr_parsing::{AttributeTemplate, template, unstable};
