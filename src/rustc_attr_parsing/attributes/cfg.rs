...
use crate::rustc_parse::parser::{ForceCollect, Parser, Recovery};
use crate::rustc_parse::{exp, parse_in};
...
use crate::rustc_span::{ErrorGuaranteed, Span, Symbol, sym};
use thin_vec::ThinVec;

use crate::rustc_attr_parsing::attributes::AttributeSafety;
use crate::rustc_attr_parsing::context::{AcceptContext, ShouldEmit};
...
use crate::rustc_attr_parsing::{AttributeParser, AttributeTemplate, check_cfg, diagnostics, parse_version, template};
