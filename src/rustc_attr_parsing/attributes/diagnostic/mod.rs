...
use crate::rustc_ast::PathSegment;
...
use crate::rustc_parse_format::{
    Argument, FormatSpec, ParseError, ParseMode, Parser, Piece as RpfPiece, Position,
};
use crate::rustc_span::edit_distance::find_best_match_for_name;
use crate::rustc_span::{Ident, InnerSpan, Span, Symbol, kw, sym};
...
use crate::rustc_attr_parsing::parser::{ArgParser, MetaItemListParser, MetaItemOrLitParser, MetaItemParser};
use crate::rustc_attr_parsing::{EmitAttribute, diagnostics};
...
impl<'sess> crate::rustc_attr_parsing::AttributeParser<'sess> {
