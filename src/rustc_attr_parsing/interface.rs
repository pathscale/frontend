...
use crate::rustc_attr_parsing::context::{
...
use crate::rustc_attr_parsing::diagnostics::ParsedDescription;
use crate::rustc_attr_parsing::parser::{AllowExprMetavar, ArgParser, PathParser, RefPathParser};
    ...
    fn check_args_used(&self, attr: &ast::Attribute, args: &ArgParser) {
        if let ArgParser::List(items) = args {
            for item in items.mixed() {
                if let crate::rustc_attr_parsing::parser::MetaItemOrLitParser::MetaItemParser(item) = item {
