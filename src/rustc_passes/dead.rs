...
impl<'tcx> MarkSymbolVisitor<'tcx> {
    ...
    fn mark_live_symbols_and_ignored_derived_traits(
        ...
        let unsolved_items = core::mem::take(&mut self.unsolved_items);
...
impl<'tcx> Visitor<'tcx> for MarkSymbolVisitor<'tcx> {
    ...
    fn visit_pat_expr(&mut self, expr: &'tcx crate::rustc_hir::PatExpr<'tcx>) -> Self::Result {
        match &expr.kind {
            ...
            ReportOn::NamedField => {
                let enum_variants_with_same_name = dead_codes
                    ...
                    .filter_map(|dead_item| {
                        ...
                        {
                            Some(crate::rustc_passes::diagnostics::EnumVariantSameName {
