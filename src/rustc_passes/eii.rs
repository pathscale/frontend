...
use crate::rustc_hir::attrs::{EiiDecl, EiiImpl};
use crate::rustc_hir::def_id::{CrateNum, DefId, LOCAL_CRATE};
use crate::rustc_middle::diagnostics::DuplicateEiiImpls;
use crate::rustc_middle::ty::TyCtxt;
use crate::rustc_structures::CrateType;

use crate::rustc_passes::diagnostics::EiiWithoutImpl;
