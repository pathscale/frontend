// One `eko::path::PathBuf`, in `CrateSource` - where a crate was loaded from.
// A path is a real filesystem concept and this is a real use of it; it goes when crate
// loading is given a source abstraction, not before.
