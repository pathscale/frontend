...
use crate::rustc_lint_defs::{declare_lint, declare_lint_pass, fcw};

pub mod hardwired {
    use super::*;

    pub fn lint_vec() -> crate::rustc_lint_defs::LintVec {
        vec![
...
declare_lint! {
    ...
    /// refer to external crates. The path prefix `crate::rustc_lint_defs::` should be used
    ...
    /// are used. You can manually change the paths to use the `crate::rustc_lint_defs::`
...
declare_lint! {
    ...
    /// // mod downstream {
    /// //     fn test() {
    /// //         let _ = crate::rustc_lint_defs::upstream::Foo; // inaccessible
    /// //     }
    /// // }
    ///
    /// pub fn main() {}
...
declare_lint! {
    ...
    /// mod m1 {
    ///     struct Priv;
    ///     impl crate::rustc_lint_defs::SemiPriv {
    ///         pub fn f(_: Priv) {}
    ///     }
    /// }
    ///
