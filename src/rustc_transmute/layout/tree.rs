...
#[cfg(feature = "rustc")]
impl From<crate::rustc_abi::Endian> for Endian {
    fn from(order: crate::rustc_abi::Endian) -> Endian {
        match order {
            crate::rustc_abi::Endian::Little => Endian::Little,
            crate::rustc_abi::Endian::Big => Endian::Big,
        }
    }
}
    ...
    T: Type,
{
    ...
    /// A `Tree` whose layout matches `core::num::NonZeroXxx`.
    #[allow(dead_code)]
...
pub(crate) mod rustc {
    ...
    use super::Tree;
    use crate::rustc_transmute::layout::Reference;
    use crate::rustc_transmute::layout::rustc::{Def, layout_of};
