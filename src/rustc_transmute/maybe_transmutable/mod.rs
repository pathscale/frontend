...
use crate::rustc_transmute::layout::{self, Def, Dfa, Reference, Tree, dfa, union};
use crate::rustc_transmute::maybe_transmutable::query_context::QueryContext;
use crate::rustc_transmute::{Answer, Condition, Map, Reason};
    ...
    C: QueryContext,
{
    src: L,
    dst: L,
    assume: crate::rustc_transmute::Assume,
    context: C,
}
...
where
    C: QueryContext,
{
    pub(crate) fn new(src: L, dst: L, assume: crate::rustc_transmute::Assume, context: C) -> Self {
...
mod rustc {
    ...
    use super::*;
    use crate::rustc_transmute::layout::tree::rustc::Err;
