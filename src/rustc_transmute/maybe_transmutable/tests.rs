...
mod alt {
    ...
    fn should_permit_identity_transmutation() {
        ...
        let answer = crate::rustc_transmute::maybe_transmutable::MaybeTransmutableQuery::new(
            layout.clone(),
            layout.clone(),
            crate::rustc_transmute::Assume::default(),
            UltraMinimal::default(),
        )
        .answer();
...
mod union {
    ...
    fn union() {
        ...
        let mut ctr = 0;
        let new_state = || {
            let state = crate::rustc_transmute::layout::dfa::State(ctr);
            ctr += 1;
            state
        };
...
mod char {
    use super::*;
    use crate::rustc_transmute::layout::tree::Endian;
...
mod nonzero {
    use super::*;
    use crate::rustc_transmute::{Answer, Reason};
...
mod r#ref {
    ...
    #[test]
    fn should_permit_identity_transmutation() {
        type Tree = crate::rustc_transmute::layout::Tree<Def, usize, ()>;
