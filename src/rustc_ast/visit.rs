...
use alloc::boxed::Box;
use alloc::vec::Vec;
pub use crate::rustc_ast_ir::visit::VisitorResult;
pub use crate::rustc_ast_ir::{try_visit, visit_opt, walk_list, walk_visitable_list};
use rustc_macros::StableHash;
use crate::rustc_span::{Ident, Span, Spanned, Symbol};
...
macro_rules! common_visitor_and_walkers {
    ($(($mut: ident))? $Visitor:ident$(<$lt:lifetime>)?) => {
        ...
        impl_visitable_noop!(<$($lt)? $($mut)?>
            ...
            char,
            crate::rustc_ast::token::CommentKind,
            crate::rustc_ast::token::Delimiter,
            crate::rustc_ast::token::Lit,
            crate::rustc_ast::token::LitKind,
            crate::rustc_ast::tokenstream::LazyAttrTokenStream,
