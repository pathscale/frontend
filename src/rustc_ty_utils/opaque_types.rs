...
use crate::rustc_ty_utils::diagnostics::{DuplicateArg, NotParam};
...
impl<'tcx> OpaqueTypeCollector<'tcx> {
    ...
    fn collect_taits_from_defines_attr(&mut self) {
        ...
        for &(span, define) in defines {
            ...
            crate::rustc_ty_walk::walk_types(self.tcx, define, self);
...
fn opaque_types_defined_by<'tcx>(
    ...
    crate::rustc_ty_walk::walk_types(tcx, item, &mut collector);
