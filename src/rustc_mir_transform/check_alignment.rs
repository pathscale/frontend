...
use crate::rustc_mir_transform::check_pointers::{BorrowedFieldProjectionMode, PointerCheck, check_pointers};

pub(super) struct CheckAlignment;

impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for CheckAlignment {
