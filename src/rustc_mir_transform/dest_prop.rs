...
use crate::rustc_middle::mir::visit::{MutVisitor, PlaceContext, VisitPlacesWith, Visitor};
use crate::rustc_middle::mir::*;
use crate::rustc_middle::ty::TyCtxt;
use crate::rustc_mir_dataflow::impls::{DefUse, LivenessTransferFunction, MaybeLiveLocals};
use crate::rustc_mir_dataflow::points::DenseLocationMap;
use crate::rustc_mir_dataflow::{Analysis, EntryStates, GenKill};
...
impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for DestinationPropagation {
...
fn dest_prop_mir_dump<'tcx>(
    ...
    if let Some(dumper) = MirDumper::new(tcx, "DestinationPropagation-dataflow", body) {
        let extra_data = &|pass_where, w: &mut dyn core::fmt::Write| {
