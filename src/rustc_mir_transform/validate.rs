...
use crate::rustc_mir_transform::util::{self, most_packed_projection};
...
impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for Validator {
...
impl<'a, 'tcx> TypeChecker<'a, 'tcx> {
    ...
    fn mir_assign_valid_types(&self, src: Ty<'tcx>, dest: Ty<'tcx>) -> bool {
        ...
        crate::rustc_mir_transform::util::relate_types(self.tcx, self.typing_env, variance, src, dest)
    }
    ...
    fn visit_rvalue(&mut self, rvalue: &Rvalue<'tcx>, location: Location) {
        ...
        match rvalue {
            ...
            Rvalue::BinaryOp(op, vals) => {
                ...
                if crate::rustc_mir_transform::util::binop_right_homogeneous(*op) {
