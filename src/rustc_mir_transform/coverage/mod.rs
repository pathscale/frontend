...
use crate::rustc_middle::mir::coverage::{CoverageKind, CoverageMirInfo};
...
use crate::rustc_mir_transform::coverage::counters::BcbCountersData;
use crate::rustc_mir_transform::coverage::graph::CoverageGraph;
use crate::rustc_mir_transform::coverage::mappings::ExtractedMappings;
...
impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for InstrumentCoverage {
