...
use crate::rustc_mir_transform::cost_checker::{CostChecker, is_call_like};
use crate::rustc_mir_transform::simplify::{UsedInStmtLocals, simplify_cfg};
use crate::rustc_mir_transform::validate::validate_types;
use crate::rustc_mir_transform::{PassPolicy, check_inline, util};
...
impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for Inline {
...
impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for ForceInline {
...
impl<'tcx> Inliner<'tcx> for ForceInliner<'tcx> {
    ...
    fn on_inline_failure(&self, callsite: &CallSite<'tcx>, reason: &'static str) {
        ...
        tcx.dcx().emit_err(crate::rustc_mir_transform::diagnostics::ForceInlineFailure {
            call_span,
            attr_span,
            ...
            justification: justification
                .map(|sym| crate::rustc_mir_transform::diagnostics::ForceInlineJustification { sym, callee }),
        });
    }
}
