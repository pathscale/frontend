...
use crate::rustc_middle::ty::layout::{IntegerExt, ValidityRequirement};
...
use crate::rustc_mir_transform::simplify::simplify_duplicate_switch_targets;
...
impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for InstSimplify {
