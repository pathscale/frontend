...
impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for MentionedItems {
...
// This visitor is carefully in sync with the one in `crate::rustc_monomorphize::collector`. We are
