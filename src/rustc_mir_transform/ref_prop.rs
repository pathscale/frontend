...
use crate::rustc_mir_transform::ssa::{SsaLocals, StorageLiveLocals};
...
impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for ReferencePropagation {
...
fn propagate_ssa<'tcx>(tcx: TyCtxt<'tcx>, body: &mut Body<'tcx>) -> bool {
    ...
    if replacer.any_replacement {
        crate::rustc_mir_transform::simplify::remove_unused_definitions(body);
    }
