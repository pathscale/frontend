...
use crate::rustc_middle::ty::{self, GenericArgsRef, InstanceKind, ShimKind, TyCtxt, TypeVisitableExt};
...
fn should_recurse<'tcx>(tcx: TyCtxt<'tcx>, callee: ty::Instance<'tcx>) -> bool {
    ...
    crate::rustc_mir_transform::pm::should_run_pass(tcx, &crate::rustc_mir_transform::inline::Inline, crate::rustc_mir_transform::pm::Optimizations::Allowed)
        || crate::rustc_mir_transform::inline::ForceInline::should_run_pass_for_callee(tcx, callee.def.def_id())
}
