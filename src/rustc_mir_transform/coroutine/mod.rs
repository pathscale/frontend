...
use crate::rustc_index::{Idx, IndexVec, indexvec};
...
use crate::rustc_mir_transform::{PassPolicy, abort_unwinding_calls, pass_manager as pm, simplify};
...
fn insert_switch<'tcx>(
    ...
    let former_entry = core::mem::replace(
...
impl<'tcx> crate::rustc_mir_transform::MirPass<'tcx> for StateTransform {
