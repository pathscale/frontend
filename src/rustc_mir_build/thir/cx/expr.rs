...
use crate::rustc_abi::{FIRST_VARIANT, FieldIdx, Size, VariantIdx};
...
use crate::rustc_hir::attrs::{AttributeKind, HasAttrs};
use crate::rustc_hir::def::{CtorKind, CtorOf, DefKind, Res};
use crate::rustc_hir::{HirId, find_attr};
...
use crate::rustc_span::{DesugaringKind, Span};
use tracing::{debug, info, instrument, trace};

use crate::rustc_mir_build::diagnostics::*;
use crate::rustc_mir_build::thir::cx::ThirBuildCx;
        ...
        let kind = match expr.kind {
            ...
            hir::ExprKind::MethodCall(segment, receiver, args, fn_span) => {
                if self.typeck_results.is_splatted_call(expr) {
                    ...
                    let args = core::iter::once(receiver)
                        .chain(args.iter())
