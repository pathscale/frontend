...
use crate::rustc_errors::{Applicability, ErrorGuaranteed, MultiSpan, msg, struct_span_code_err};
...
use crate::rustc_pattern_analysis::diagnostics::Uncovered;
                ...
                && let [_, snd_arm] = *arms
            {
                ...
                let would_be_exhaustive_without_guards = {
                    ...
                    any_arm_has_guard && {
                        ...
                        crate::rustc_pattern_analysis::rustc::analyze_match(&cx, &guardless_arms, scrut.ty)
