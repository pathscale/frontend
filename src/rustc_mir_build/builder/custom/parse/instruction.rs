...
use crate::rustc_span::{Span, Spanned};

use super::{PResult, ParseCtxt, parse_by_kind};
use crate::rustc_mir_build::builder::custom::ParseError;
use crate::rustc_mir_build::builder::expr::as_constant::as_constant_inner;
    ...
    fn parse_rvalue(&self, expr_id: ExprId) -> PResult<Rvalue<'tcx>> {
        parse_by_kind!(self, expr_id, expr, "rvalue",
            ...
            ExprKind::Adt(adt_expr) => {
                let AdtExpr { adt_def, variant_index, args, fields, .. } = &**adt_expr;
