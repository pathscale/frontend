...
use crate::rustc_middle::middle::region::{Scope, ScopeData, TempLifetime};
use crate::rustc_middle::mir::*;
use crate::rustc_middle::thir::*;
use tracing::{debug, instrument};

use crate::rustc_mir_build::builder::scope::LintLevel;
use crate::rustc_mir_build::builder::{BlockAnd, BlockAndExtension, Builder};
...
impl<'a, 'tcx> Builder<'a, 'tcx> {
    ...
    pub(crate) fn as_temp(
        ...
        let temp = if deduplicate_temps && let Some(temp_index) = this.fixed_temps.get(&expr_id) {
            ...
            *local_decl.local_info_mut() = local_info;
