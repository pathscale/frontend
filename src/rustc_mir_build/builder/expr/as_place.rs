...
use crate::rustc_mir_build::builder::ForGuard::{OutsideGuard, RefWithinGuard};
use crate::rustc_mir_build::builder::expr::category::Category;
use crate::rustc_mir_build::builder::scope::LintLevel;
use crate::rustc_mir_build::builder::{BlockAnd, BlockAndExtension, Builder, Capture, CaptureMap};
...
pub(in crate::rustc_mir_build::builder) struct PlaceBuilder<'tcx> {
    base: PlaceBase,
...
impl<'tcx> PlaceBuilder<'tcx> {
    pub(in crate::rustc_mir_build::builder) fn to_place(&self, cx: &Builder<'_, 'tcx>) -> Place<'tcx> {
    ...
    pub(in crate::rustc_mir_build::builder) fn try_to_place(&self, cx: &Builder<'_, 'tcx>) -> Option<Place<'tcx>> {
    ...
    pub(in crate::rustc_mir_build::builder) fn resolve_upvar(
        &self,
        cx: &Builder<'_, 'tcx>,
    ) -> Option<PlaceBuilder<'tcx>> {
...
impl<'a, 'tcx> Builder<'a, 'tcx> {
    ...
    pub(in crate::rustc_mir_build::builder) fn len_of_slice_or_array(
        &mut self,
        block: BasicBlock,
        place: Place<'tcx>,
        span: Span,
