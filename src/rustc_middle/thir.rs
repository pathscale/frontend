...
use crate::rustc_ast::{AsmMacro, InlineAsmOptions, InlineAsmTemplatePiece, Mutability};
...
use crate::rustc_middle::mir::{self, AssignOp, BinOp, BorrowKind, FakeReadCause, UnOp};
use crate::rustc_middle::thir::visit::for_each_immediate_subpat;
...
pub enum ExprKind<'tcx> {
    ...
    ///
    /// [`Adjust::GenericReborrow`]: crate::rustc_middle::ty::adjustment::Adjust::GenericReborrow
...
mod size_asserts {
    ...
    static_assert_size!(Block, 64);
    static_assert_size!(Expr<'_>, 64);
    static_assert_size!(ExprKind<'_>, 40);
    static_assert_size!(Pat<'_>, 72);
    static_assert_size!(PatKind<'_>, 48);
    static_assert_size!(Stmt<'_>, 64);
