...
use crate::rustc_span::Spanned;
use crate::rustc_type_ir::{ConstKind, TypeFolder, VisitorResult, try_visit};

use super::{GenericArg, GenericArgKind, Pattern};
use crate::rustc_middle::mir::PlaceElem;
use crate::rustc_middle::ty::print::{FmtPrinter, Printer, with_no_trimmed_paths};
...
TrivialLiftImpls! {
    ...
    crate::rustc_middle::mir::interpret::Scalar,
    crate::rustc_middle::ty::ParamConst,
...
TrivialTypeTraversalImpls! {
    // tidy-alphabetical-start
    crate::rustc_middle::infer::canonical::Certainty,
    crate::rustc_middle::mir::BasicBlock,
    crate::rustc_middle::mir::BindingForm<'tcx>,
    crate::rustc_middle::mir::BlockTailInfo,
    crate::rustc_middle::mir::BorrowKind,
    crate::rustc_middle::mir::CastKind,
    crate::rustc_middle::mir::ConstValue,
    crate::rustc_middle::mir::CoroutineSavedLocal,
    crate::rustc_middle::mir::FakeReadCause,
    crate::rustc_middle::mir::Local,
    crate::rustc_middle::mir::MirPhase,
    crate::rustc_middle::mir::Promoted,
    crate::rustc_middle::mir::RawPtrKind,
    crate::rustc_middle::mir::SourceInfo,
    crate::rustc_middle::mir::SourceScope,
    crate::rustc_middle::mir::SourceScopeLocalData,
    crate::rustc_middle::mir::SwitchTargets,
    crate::rustc_middle::mir::WithRetag,
    crate::rustc_middle::traits::IsConstable,
    crate::rustc_middle::traits::OverflowError,
    crate::rustc_middle::ty::AdtKind,
    crate::rustc_middle::ty::AssocItem,
    crate::rustc_middle::ty::AssocKind,
    crate::rustc_middle::ty::BoundRegion<'tcx>,
    crate::rustc_middle::ty::BoundTy<'tcx>,
    crate::rustc_middle::ty::ScalarInt,
    crate::rustc_middle::ty::UserTypeAnnotationIndex,
    crate::rustc_middle::ty::abstract_const::NotConstEvaluatable,
    crate::rustc_middle::ty::adjustment::AutoBorrowMutability,
    crate::rustc_middle::ty::adjustment::PointerCoercion,
...
TrivialTypeTraversalAndLiftImpls! {
    // tidy-alphabetical-start
    crate::rustc_middle::mir::RuntimeChecks,
    crate::rustc_middle::ty::ParamTy,
    crate::rustc_middle::ty::instance::ReifyReason,
