//! Implementation of [`crate::rustc_type_ir::Interner`] for [`TyCtxt`].
...
use crate::rustc_middle::infer::canonical::CanonicalVarKinds;
use crate::rustc_middle::traits::cache::WithDepNode;
...
impl<'tcx> Interner for TyCtxt<'tcx> {
    ...
    type AllocId = crate::rustc_middle::mir::interpret::AllocId;
...
impl<'tcx, T: core::fmt::Debug + Clone + Copy> crate::rustc_type_ir::intern::Interned<TyCtxt<'tcx>>
    for Interned<'tcx, T>
{
    type Value = T;
    fn get(self) -> T {
