...
use crate::rustc_type_ir as ir;

use crate::rustc_middle::ty::{self, EarlyBinder, Ty, TyCtxt, TypeFlags, Upcast, UpcastFrom, WithCachedTypeInfo};
...
impl<'tcx> crate::rustc_type_ir::inherent::Predicate<TyCtxt<'tcx>> for Predicate<'tcx> {
    fn as_clause(self) -> Option<ty::Clause<'tcx>> {
        self.as_clause()
    }
}

impl<'tcx> crate::rustc_type_ir::inherent::IntoKind for Predicate<'tcx> {
...
impl<'tcx> crate::rustc_type_ir::Flags for Predicate<'tcx> {
...
impl<'tcx> Predicate<'tcx> {
    ...
    pub fn allow_normalization(self) -> bool {
        crate::rustc_type_ir::inherent::Predicate::allow_normalization(self)
    }
}
...
impl<'tcx> crate::rustc_errors::IntoDiagArg for Predicate<'tcx> {
    fn into_diag_arg(self, path: &mut crate::rustc_errors::LongTyPath) -> crate::rustc_errors::DiagArgValue {
        ty::tls::with(|tcx| {
            ...
            crate::rustc_errors::DiagArgValue::Str(alloc::borrow::Cow::Owned(pred))
        })
    }
}
...
impl<'tcx> crate::rustc_errors::IntoDiagArg for Clause<'tcx> {
    fn into_diag_arg(self, path: &mut crate::rustc_errors::LongTyPath) -> crate::rustc_errors::DiagArgValue {
        ty::tls::with(|tcx| {
            ...
            crate::rustc_errors::DiagArgValue::Str(alloc::borrow::Cow::Owned(clause))
        })
    }
}
...
impl<'tcx> crate::rustc_type_ir::inherent::Clause<TyCtxt<'tcx>> for Clause<'tcx> {
...
impl<'tcx> crate::rustc_type_ir::inherent::IntoKind for Clause<'tcx> {
...
impl<'tcx> crate::rustc_type_ir::Flags for Clause<'tcx> {
    fn flags(&self) -> TypeFlags {
        self.0.flags
    }
...
impl<'tcx> crate::rustc_type_ir::inherent::Clauses<TyCtxt<'tcx>> for ty::Clauses<'tcx> {}
...
impl<'tcx> crate::rustc_type_ir::inherent::BoundExistentialPredicates<TyCtxt<'tcx>>
...
impl<'tcx> ty::List<ty::PolyExistentialPredicate<'tcx>> {
    ...
    ///
    /// For example, in the trait object `dyn core::fmt::Debug + Sync`, the
    /// principal bound is `Some(core::fmt::Debug)`, while the auto-trait bounds
    /// are the set `{Sync}`.
    ///
