...
use crate::rustc_type_ir::{self as ir, TypeFlags, WithCachedTypeInfo};
...
impl<'tcx> crate::rustc_type_ir::Flags for Const<'tcx> {
...
impl<'tcx> crate::rustc_type_ir::inherent::Const<TyCtxt<'tcx>> for Const<'tcx> {
    ...
    fn new_canonical_bound(tcx: TyCtxt<'tcx>, var: crate::rustc_type_ir::BoundVar) -> Self {
