...
use crate::rustc_type_ir::{self as ir, FlagComputation, Flags};
...
impl<'tcx> Flags for Pattern<'tcx> {
    fn flags(&self) -> crate::rustc_type_ir::TypeFlags {
        match &**self {
            ...
            ty::PatternKind::NotNull => crate::rustc_type_ir::TypeFlags::empty(),
        }
    }

    fn outer_exclusive_binder(&self) -> crate::rustc_type_ir::DebruijnIndex {
        match &**self {
            ty::PatternKind::Range { start, end } => {
            ...
            ty::PatternKind::NotNull => crate::rustc_type_ir::INNERMOST,
        }
    }
}
...
impl<'tcx> crate::rustc_type_ir::inherent::IntoKind for Pattern<'tcx> {
