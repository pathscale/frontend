...
use super::ScalarInt;
use crate::rustc_middle::mir::interpret::{ErrorHandled, Scalar};
use crate::rustc_middle::ty::print::{FmtPrinter, PrettyPrinter};
use crate::rustc_middle::ty::{self, Ty, TyCtxt, ValTreeKind};
...
impl<'tcx> crate::rustc_type_ir::inherent::IntoKind for ty::ValTree<'tcx> {
...
impl<'tcx> crate::rustc_type_ir::inherent::ValueConst<TyCtxt<'tcx>> for Value<'tcx> {
    fn ty(self) -> Ty<'tcx> {
        self.ty
    }
