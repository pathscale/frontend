...
use crate::rustc_middle::ty::Const;
use crate::rustc_serialize::{Decodable, Encodable};
use crate::rustc_span::{Span, SpanDecoder, SpanEncoder, Spanned};

use crate::rustc_middle::infer::canonical::{CanonicalVarKind, CanonicalVarKinds};
use crate::rustc_middle::mir::interpret::{AllocId, ConstAllocation, CtfeProvenance};
use crate::rustc_middle::mono::MonoItem;
use crate::rustc_middle::ty::{self, AdtDef, GenericArgsRef, Ty, TyCtxt};
...
pub trait TyDecoder<'tcx>:
    SpanDecoder + crate::rustc_type_ir::InternerDecoder<Interner = TyCtxt<'tcx>>
{
    const CLEAR_CROSS_CRATE: bool;
