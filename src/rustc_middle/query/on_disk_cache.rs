...
use crate::rustc_middle::dep_graph::{DepNodeIndex, QuerySideEffect, SerializedDepNodeIndex};
use crate::rustc_middle::mir::interpret::{AllocDecodingSession, AllocDecodingState};
use crate::rustc_middle::mir::{self, interpret};
use crate::rustc_middle::mono::MonoItem;
use crate::rustc_middle::ty::codec::{RefDecodable, TyDecoder, TyEncoder};
...
impl<'a, 'tcx> crate::rustc_type_ir::InternerDecoder for CacheDecoder<'a, 'tcx> {
...
impl<'a, 'tcx> Decodable<CacheDecoder<'a, 'tcx>>
    for &'tcx crate::rustc_middle::traits::specialization_graph::Graph
{
    #[inline]
    fn decode(d: &mut CacheDecoder<'a, 'tcx>) -> Self {
        RefDecodable::decode(d)
...
impl<'a, 'tcx> Decodable<CacheDecoder<'a, 'tcx>> for &'tcx crate::rustc_ast::tokenstream::TokenStream {
    #[inline]
    fn decode(d: &mut CacheDecoder<'a, 'tcx>) -> Self {
        RefDecodable::decode(d)
    }
