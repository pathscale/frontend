...
use crate::rustc_middle::dep_graph::DepNodeKey;
use crate::rustc_middle::query::erase::{self, Erasable, Erased};
use crate::rustc_middle::query::{IntoQueryKey, QueryCache, QueryMode, QueryVTable};
...
/// Called by macro-generated methods of [`crate::rustc_middle::ty::TyCtxtFeed`].
