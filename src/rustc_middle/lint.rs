...
use crate::rustc_errors::{Diag, DiagLocation, Diagnostic, MultiSpan};
...
use crate::rustc_span::{DUMMY_SP, ExpnKind, Span, Symbol, kw};
...
pub fn emit_lint_base<'a, D: Diagnostic<'a, ()> + 'a>(
    ...
    fn emit_lint_base_impl<'a>(
        ...
        span: Option<MultiSpan>,
        decorate: Box<
            dyn FnOnce(crate::rustc_errors::DiagCtxtHandle<'a>, crate::rustc_errors::Level) -> Diag<'a, ()> + 'a,
        >,
    ) {
