...
use crate::rustc_hir::attrs::{InlineAttr, InstructionSetAttr, Linkage, OptimizeAttr, RtsanSetting};
...
use crate::rustc_middle::ty::{InstanceKind, ShimKind, TyCtxt};
...
crate::external_bitflags_debug! { CodegenFnAttrFlags }
