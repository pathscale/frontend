...
impl EncoderState {
    ...
    fn print_incremental_info(
        ...
        if let Some(record_stats) = &self.stats {
            ...
            eko::eprintln!("[incremental]");
            eko::eprintln!("[incremental] DepGraph Statistics");
            eko::eprintln!("{SEPARATOR}");
            eko::eprintln!("[incremental]");
            eko::eprintln!("[incremental] Total Node Count: {}", total_node_count);
            eko::eprintln!("[incremental] Total Edge Count: {}", total_edge_count);
            ...
            if cfg!(debug_assertions) {
                ...
                eko::eprintln!("[incremental] Total Edge Reads: {total_read_count}");
                eko::eprintln!("[incremental] Total Duplicate Edge Reads: {total_duplicate_read_count}");
            }
