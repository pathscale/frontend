...
use crate::rustc_lint_defs::builtin::CONST_EVALUATABLE_UNCHECKED;
...
use crate::rustc_middle::mir::interpret::ValTreeCreationError;
use crate::rustc_middle::ty::{self, ConstToValTreeResult, GenericArgs, TyCtxt, TypeVisitableExt};
use crate::rustc_middle::{diagnostics, mir};
                ...
                && let Some(local_def_id) = def_id.as_local()
            {
                ...
                if mir_body.is_polymorphic {
                    self.emit_node_span_lint(
                        ...
                        crate::rustc_errors::DiagDecorator(|lint| {
