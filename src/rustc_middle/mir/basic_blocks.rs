...
use crate::rustc_middle::mir::traversal::Postorder;
use crate::rustc_middle::mir::{BasicBlock, BasicBlockData, START_BLOCK};
...
impl<'tcx> BasicBlocks<'tcx> {
    ...
    ///
    /// [`traversal::reverse_postorder`]: crate::rustc_middle::mir::traversal::reverse_postorder
    #[inline]
