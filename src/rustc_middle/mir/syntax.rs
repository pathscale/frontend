...
/// from one IR to another. In other words, a single well-formed [`Body`](crate::rustc_middle::mir::Body) might
...
pub enum StatementKind<'tcx> {
    ...
    /// [`Scalar::Initialized`][crate::rustc_abi::Scalar::Initialized]. As a part of this discussion, it is
    ...
    /// [`mir::Body::coverage_mir_info`](crate::rustc_middle::mir::Body::coverage_mir_info).
...
pub enum Rvalue<'tcx> {
    ...
    ///
    /// [`discriminant_ty`]: crate::rustc_middle::ty::Ty::discriminant_ty
    /// [#91095]: https://github.com/rust-lang/rust/issues/91095
    /// [`discriminant_for_variant`]: crate::rustc_middle::ty::Ty::discriminant_for_variant
...
pub enum BinOp {
    ...
    /// [`LangItem::OrderingEnum`] (aka [`core::cmp::Ordering`]).
    ///
    ...
    ///
    /// [`LangItem::OrderingEnum`]: crate::rustc_hir::attrs::lang_items::LangItem
    Cmp,
