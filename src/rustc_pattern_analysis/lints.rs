...
use crate::rustc_pattern_analysis::diagnostics::{
...
use crate::rustc_pattern_analysis::rustc::{RevealedTy, RustcPatCtxt, WitnessPat};
...
pub(crate) fn lint_nonexhaustive_missing_variants<'p, 'tcx>(
        ...
        .is_allow()
    {
        ...
        for arm in arms {
            ...
            if level != crate::rustc_lint_defs::Level::Allow {
