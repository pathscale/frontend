//! As explained in [`crate::rustc_pattern_analysis::usefulness`], values and patterns are made from constructors applied to
...
//!
//! Constructor splitting is mentioned in [`crate::rustc_pattern_analysis::usefulness`] but not detailed. We describe it
//! precisely here.
//!
//!
//!
...
//!
//! As explained in the corresponding section in [`crate::rustc_pattern_analysis::usefulness`], to make usefulness tractable
...
//! `151..=200` and `200..`.
//!
//! In [`crate::rustc_pattern_analysis::usefulness`], we had said that `specialize` only takes value-only constructors. We
...
//! (see `crate::rustc_pattern_analysis::usefulness::WitnessMatrix::apply_constructor`).
//!
//! We choose whether to specialize with `Missing` in
//! `crate::rustc_pattern_analysis::usefulness::compute_exhaustiveness_and_usefulness`.
//!
//!
//!
...
//! place validity that are handled in `crate::rustc_pattern_analysis::usefulness`. Yes this is a bit tricky.
//!
...
use self::SliceKind::*;
use crate::rustc_pattern_analysis::PatCx;
