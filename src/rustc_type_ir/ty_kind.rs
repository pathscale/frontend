...
use crate::rustc_type_ir::data_structures::{NoError, UnifyKey, UnifyValue};
use rustc_macros::{
...
use crate::rustc_type_ir::ty::AliasTy;
...
impl<I: Interner> fmt::Debug for TyKind<I> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Param(p) => write!(f, "{p:?}"),
            Bound(d, b) => crate::rustc_type_ir::debug_bound_var(f, *d, b),
...
impl<I: Interner> FnSigKind<I> {
    ...
    /// `crate::rustc_ast::FnDecl::NO_SPLATTED_ARG_INDEX`.
    ///
