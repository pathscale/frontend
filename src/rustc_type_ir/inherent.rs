...
//! It is customary to glob-import `crate::rustc_type_ir::inherent::*` to bring all of these traits into
...
use crate::rustc_ast_ir::Mutability;

use crate::rustc_type_ir::elaborate::Elaboratable;
use crate::rustc_type_ir::fold::{TypeFoldable, TypeSuperFoldable};
use crate::rustc_type_ir::relate::Relate;
use crate::rustc_type_ir::solve::{AdtDestructorKind, SizedTraitKind};
use crate::rustc_type_ir::visit::{Flags, TypeSuperVisitable, TypeVisitable};
...
pub trait SpecificDefId<I: Interner, Local = <I as Interner>::LocalDefId>:
    DefId<I, Local> + Into<I::DefId> + TryFrom<I::DefId, Error: core::fmt::Debug>
{
}

impl<
    I: Interner,
    T: DefId<I, Local> + Into<I::DefId> + TryFrom<I::DefId, Error: core::fmt::Debug>,
    Local,
