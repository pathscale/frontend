...
use crate::rustc_type_ir::lang_items::SolverTraitLangItem;
use crate::rustc_type_ir::outlives::{Component, push_outlives_components};
use crate::rustc_type_ir::{self as ty, Interner, Region, Unnormalized, Upcast as _};
...
impl<I: Interner> Elaboratable<I> for ClauseWithSupertraitSpan<I> {
    ...
    fn child_with_derived_cause(
        ...
        _parent_trait_pred: crate::rustc_type_ir::Binder<I, crate::rustc_type_ir::TraitClause<I>>,
        _index: usize,
    ) -> Self {
