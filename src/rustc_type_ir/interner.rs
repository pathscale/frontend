...
use crate::rustc_ast_ir::Movability;
use crate::rustc_ast_ir::visit::VisitorResult;
#[cfg(feature = "nightly")]
use crate::rustc_data_structures::stable_hash::StableHash;
use crate::rustc_index::bit_set::DenseBitSet;

use crate::rustc_type_ir::fold::TypeFoldable;
use crate::rustc_type_ir::inherent::*;
use crate::rustc_type_ir::intern::Interned;
use crate::rustc_type_ir::ir_print::IrPrint;
...
macro_rules! declare_lift_into {
    ($($assoc:ident),* $(,)?) => {
        ...
        /// implied.
        pub trait LiftInto<J>: Interner<$($assoc: crate::rustc_type_ir::lift::Lift<J, Lifted = J::$assoc>,)*>
        where
            J: Interner,
        {}
        ...
        where
            J: Interner,
            I: Interner<$($assoc: crate::rustc_type_ir::lift::Lift<J, Lifted = J::$assoc>,)*>,
        {}
    };
}
