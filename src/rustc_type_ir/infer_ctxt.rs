...
use crate::rustc_type_ir::data_structures::DelayedMap;
use crate::rustc_type_ir::inherent::*;
use crate::rustc_type_ir::relate::RelateResult;
use crate::rustc_type_ir::relate::combine::PredicateEmittingRelation;
use crate::rustc_type_ir::solve::{TyOrConstInferVar, VisibleForLeakCheck};
...
pub trait InferCtxtLike: Sized {
    ...
    fn insert_placeholder_assumptions(
        &self,
        u: ty::UniverseIndex,
        assumptions: Option<crate::rustc_type_ir::region_constraint::Assumptions<Self::Interner>>,
    );
    fn get_placeholder_assumptions(
        &self,
        u: ty::UniverseIndex,
    ) -> Option<crate::rustc_type_ir::region_constraint::Assumptions<Self::Interner>>;
    fn get_solver_region_constraint(
        &self,
    ) -> crate::rustc_type_ir::region_constraint::RegionConstraint<Self::Interner>;
    fn overwrite_solver_region_constraint(
        &self,
        constraint: crate::rustc_type_ir::region_constraint::RegionConstraint<Self::Interner>,
    ...
    fn register_solver_region_constraint(
        &self,
        c: crate::rustc_type_ir::region_constraint::RegionConstraint<Self::Interner>,
        span: <Self::Interner as Interner>::Span,
    );
