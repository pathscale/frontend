...
use crate::rustc_lint_defs::builtin::UNFULFILLED_LINT_EXPECTATIONS;
use crate::rustc_lint_defs::{LintExpectationId, StableLintExpectationId};
use crate::rustc_middle::lint::LintExpectation;
use crate::rustc_middle::query::Providers;
use crate::rustc_middle::ty::TyCtxt;
use crate::rustc_span::Symbol;

use crate::rustc_lint::diagnostics::{Expectation, ExpectationNote};
