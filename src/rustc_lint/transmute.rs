...
use crate::rustc_lint_defs::{declare_lint, impl_lint_pass};
use rustc_macros::Diagnostic;
use crate::rustc_middle::ty::{self, Ty};
use crate::rustc_span::sym;

use crate::rustc_lint::diagnostics::{IntegerToPtrTransmutes, IntegerToPtrTransmutesSuggestion};
...
declare_lint! {
    ...
    ///    unsafe {
    ///        core::mem::transmute::<*const u8, usize>(ptr)
    ///    }
    /// }
    /// ```
    ///
    ...
    ///
    /// See [core::mem::transmute] in the reference for more details.
    ///
    /// [core::mem::transmute]: https://doc.rust-lang.org/std/mem/fn.transmute.html
...
declare_lint! {
    ...
    ///    unsafe {
    ///        core::mem::transmute::<usize, *const u8>(a)
    ///    }
    /// }
    /// ```
    ///
    ...
    ///
    /// Alternatively, [`core::ptr::with_exposed_provenance`] should be used, as they do not
    /// carry the provenance requirement. If wanting to create pointers without provenance
    /// [`core::ptr::without_provenance`] should be used instead.
    ///
    /// See [`core::mem::transmute`] in the reference for more details.
    ///
    /// [`core::mem::transmute`]: https://doc.rust-lang.org/std/mem/fn.transmute.html
    /// [`core::ptr::with_exposed_provenance`]: https://doc.rust-lang.org/std/ptr/fn.with_exposed_provenance.html
    /// [`core::ptr::without_provenance`]: https://doc.rust-lang.org/std/ptr/fn.without_provenance.html
