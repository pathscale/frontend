...
use crate::rustc_hir::{Block, Body, Expr, ExprKind, FnDecl, FnRetTy, TyKind, find_attr};
...
use crate::rustc_lint::diagnostics::{DanglingPointersFromLocals, DanglingPointersFromTemporaries};
