...
use crate::bug;
use crate::rustc_middle::lint::{LevelSpec, StableLevelSpec, UnstableLevelSpec};
...
impl LintStore {
    ...
    pub fn is_lint_group(&self, lint_name: Symbol) -> bool {
        ...
        self.lint_groups.contains_key(lint_name_str) || {
            let warnings_name_str = crate::rustc_lint::WARNINGS.name_lower();
...
pub struct EarlyContext<'a> {
    pub builder: LintLevelsBuilder<'a, crate::rustc_lint::levels::TopDown>,
...
pub trait LintContext {
    ...
    ///
    /// [`emit_lint_base`]: crate::rustc_middle::lint::emit_lint_base#decorate-signature
    #[track_caller]
