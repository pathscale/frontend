...
use crate::rustc_lint::EarlyLintPass;
use crate::rustc_lint::diagnostics::MacroExprFragment2024;
...
impl Expr2024 {
    fn check_tokens(&mut self, cx: &crate::rustc_lint::EarlyContext<'_>, tokens: &TokenStream) {
    ...
    fn check_ident_token(&mut self, cx: &crate::rustc_lint::EarlyContext<'_>, token: &Token) {
...
impl EarlyLintPass for Expr2024 {
    fn check_mac_def(&mut self, cx: &crate::rustc_lint::EarlyContext<'_>, mc: &crate::rustc_ast::MacroDef) {
