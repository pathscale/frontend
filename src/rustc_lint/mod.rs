...
//! within [crate::rustc_lint_defs::builtin],
...
use crate::rustc_hir::def_id::LocalModId;
...
pub use crate::rustc_errors::BufferedEarlyLint;
pub use crate::rustc_lint_defs::Level::{self, *};
pub use crate::rustc_lint_defs::{
...
#[cfg(test)]
mod tests;
pub use crate::declare_combined_early_lint_pass;
pub use crate::declare_combined_late_lint_pass;
pub use crate::early_lint_methods;
pub use crate::expand_combined_early_lint_pass_method;
pub use crate::expand_combined_early_lint_pass_methods;
pub use crate::expand_combined_late_lint_pass_method;
pub use crate::expand_combined_late_lint_pass_methods;
pub use crate::late_lint_methods;
