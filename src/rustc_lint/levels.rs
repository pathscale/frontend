...
use crate::rustc_errors::{Diag, DiagCtxtHandle, Diagnostic, MultiSpan, msg};
...
use crate::rustc_span::{AttrId, DUMMY_SP, Span, Symbol, sym};
use tracing::{debug, instrument};

use crate::rustc_lint::builtin::MISSING_DOCS;
use crate::rustc_lint::context::{CheckLintNameResult, LintStore};
...
use crate::rustc_lint::late::unerased_lint_store;
    ...
    LevelSpec<P::LintExpectationId>: Into<LevelSpec>,
{
    ...
    fn add_command_line(&mut self) {
        for &(ref lint_name, level) in &self.sess.opts.lint_opts {
            ...
            if lint_name_only == crate::rustc_lint::WARNINGS.name_lower() && matches!(level, Level::ForceWarn) {
                self.sess
                    .dcx()
                    .emit_err(UnsupportedGroup { lint_group: crate::rustc_lint::WARNINGS.name_lower() });
            }
