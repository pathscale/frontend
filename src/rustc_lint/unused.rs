...
use crate::rustc_ast::{self as ast, ExprKind, FnRetTy, ForLoop, HasAttrs as _, StmtKind};
use crate::rustc_data_structures::fx::FxHashMap;
use crate::rustc_errors::MultiSpan;
use crate::rustc_hir as hir;
use crate::rustc_lint_defs::{declare_lint, declare_lint_pass, impl_lint_pass};
use crate::rustc_middle::ty::{self, adjustment};
use crate::rustc_span::edition::Edition::Edition2015;
use crate::rustc_span::{BytePos, Span, kw, sym};
...
use crate::rustc_lint::{EarlyContext, EarlyLintPass, LateContext, LateLintPass, Lint, LintContext};
