...
use crate::rustc_ast::attr::MarkedAttrs;
...
use crate::rustc_span::def_id::{CrateNum, DefId, LocalDefId, ModId};
...
use crate::rustc_structures::{CollapseMacroDebuginfo, Limit};
use smallvec::{SmallVec, smallvec};
use thin_vec::ThinVec;

use crate::rustc_expand::diagnostics;
use crate::rustc_expand::expand::{self, AstFragment, Invocation};
use crate::rustc_expand::mbe::macro_rules::ParserAnyMacro;
use crate::rustc_expand::module::DirOwnership;
use crate::rustc_expand::stats::MacroStat;
...
pub enum SyntaxExtensionKind {
    ...
    MacroRules(Arc<crate::rustc_expand::MacroRulesMacroExpander>),
...
pub struct SyntaxExtension {
    ...
    /// Enables the macro helper hack (`ident!(...)` -> `$crate::rustc_expand::ident!(...)`) for this macro.
