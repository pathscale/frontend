...
use crate::rustc_expand::mbe::macro_rules::Tracker;
use crate::rustc_expand::mbe::{KleeneOp, TokenTree};
...
crate::static_assert_size!(MatcherPos, 16);
...
impl TtParser {
    ...
    fn check_for_ambiguity<'matcher, R, T: Tracker<'matcher>>(
        ...
        if core::mem::take(&mut self.found_ambiguity) || !self.next_mps.is_empty() {
