...
use crate::polonius_engine::output::{Context, Output};
        ...
        while iteration.changed() {
            ...
            subset_placeholder.from_leapjoin(
                ...
                (
                    ...
                    // remove symmetries:
                    crate::datafrog::ValueFilter::from(|&((origin1, _point), origin2), _| {
                        origin1 != origin2
                    }),
                ),
            ...
            subset_errors.from_leapjoin(
                ...
                (
                    ...
                    // remove symmetries:
                    crate::datafrog::ValueFilter::from(|&(origin1, origin2, _point), _| {
                        origin1 != origin2
                    }),
                ),
