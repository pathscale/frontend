...
use crate::datafrog::Relation;
use crate::polonius_engine::fx::{FxHashMap, FxHashSet};
use alloc::borrow::Cow;
use alloc::collections::{BTreeMap, BTreeSet};

use crate::polonius_engine::facts::{AllFacts, Atom, FactTypes};
...
impl<T: FactTypes> Output<T> {
    ...
    fn compute_known_contains(
        ...
        let mut iteration = crate::datafrog::Iteration::new();
    ...
    fn compute_known_placeholder_subset(
        ...
        use crate::datafrog::{Iteration, RelationLeaper};
