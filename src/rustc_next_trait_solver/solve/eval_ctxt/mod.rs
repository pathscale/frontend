...
use crate::rustc_type_ir::data_structures::HashSet;
use crate::rustc_type_ir::inherent::*;
use crate::rustc_type_ir::region_constraint::{RegionConstraint, evaluate_solver_constraint};
use crate::rustc_type_ir::relate::Relate;
use crate::rustc_type_ir::relate::solver_relating::RelateExt;
use crate::rustc_type_ir::search_graph::{
...
use crate::rustc_next_trait_solver::canonical::{
    canonicalize_goal, canonicalize_response, instantiate_and_apply_query_response,
    response_no_constraints_raw,
};
use crate::rustc_next_trait_solver::coherence;
use crate::rustc_next_trait_solver::delegate::SolverDelegate;
use crate::rustc_next_trait_solver::normalize::{NormalizationFolder, NormalizationWasAmbiguous};
use crate::rustc_next_trait_solver::placeholder::BoundVarReplacer;
use crate::rustc_next_trait_solver::solve::eval_ctxt::fast_path::{
...
use crate::rustc_next_trait_solver::solve::fast_path::compute_goal_fast_path_cold;
use crate::rustc_next_trait_solver::solve::search_graph::SearchGraph;
use crate::rustc_next_trait_solver::solve::ty::may_use_unstable_feature;
    ...
    I: Interner,
{
    ...
    #[instrument(level = "trace", skip(self), ret)]
    pub(in crate::rustc_next_trait_solver::solve) fn evaluate_added_goals_and_make_canonical_response(
        &mut self,
    ...
    pub(in crate::rustc_next_trait_solver::solve) fn make_ambiguous_response_no_constraints(
        &self,
        maybe: MaybeInfo,
    ) -> CanonicalResponse<I> {
        response_no_constraints_raw(
