...
pub use crate::rustc_type_ir::solve::*;
use crate::rustc_type_ir::{self as ty, Interner, Region, TypeVisitableExt};
    ...
    I: Interner,
{
    ...
    fn compute_region_outlives_goal(
        ...
        if self.cx().assumptions_on_binders() {
            let constraint =
                crate::rustc_type_ir::region_constraint::RegionConstraint::RegionOutlives(a, b, ());
            self.register_solver_region_constraint(constraint);
        } else {
