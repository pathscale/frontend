...
use crate::rustc_middle::ty::print::{with_no_trimmed_paths, with_types_for_signature};
...
fn report_mismatched_rpitit_signature<'tcx>(
    ...
    tcx.emit_node_span_lint(
        ...
        span,
        crate::rustc_hir_analysis::diagnostics::ReturnPositionImplTraitInTraitRefined {
            impl_return_span,
            trait_return_span,
            pre,
            post,
...
fn report_mismatched_rpitit_captures<'tcx>(
    ...
    tcx.emit_node_span_lint(
        ...
        use_bound_span,
        crate::rustc_hir_analysis::diagnostics::ReturnPositionImplTraitInTraitRefinedLifetimes {
