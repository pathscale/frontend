...
use crate::rustc_errors::{Applicability, Diag, Diagnostic, EmissionGuarantee, MultiSpan, pluralize};
use crate::rustc_hir as hir;
use crate::rustc_middle::ty::{self as ty, AssocItem, AssocItems, TyCtxt};
