...
use crate::rustc_hir::intravisit::{self, Visitor, walk_lifetime};
use crate::rustc_hir::{GenericArg, HirId, LifetimeKind, Path, QPath, TyKind};
use crate::rustc_middle::hir::nested_filter::All;
use crate::rustc_middle::ty::{GenericParamDef, GenericParamDefKind, TyCtxt};

use crate::rustc_hir_analysis::hir::def::Res;
...
impl<'tcx> Visitor<'tcx> for ParamUsageVisitor<'tcx> {
    ...
    fn visit_lifetime(&mut self, lifetime: &'tcx crate::rustc_hir::Lifetime) -> Self::Result {
