...
use crate::rustc_metadata::rmeta::EncodeContext;
use crate::rustc_metadata::rmeta::decoder::BlobDecodeContext;

pub(crate) enum DefPathHashMapRef<'tcx> {
    OwnedFromMetadata(crate::odht::HashTable<HashMapConfig, OwnedSlice>),
...
impl<'a> Decodable<BlobDecodeContext<'a>> for DefPathHashMapRef<'static> {
    fn decode(d: &mut BlobDecodeContext<'a>) -> DefPathHashMapRef<'static> {
        ...
        let inner = crate::odht::HashTable::from_raw_bytes(o).unwrap_or_else(|e| {
