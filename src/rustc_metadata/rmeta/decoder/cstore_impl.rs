...
use crate::rustc_crate_store::{CrateStore, ExternCrate};
...
use crate::rustc_metadata::rmeta::AttrFlags;
...
macro_rules! provide_one {
    ...
    ($tcx:ident, $def_id:ident, $other:ident, $cdata:ident, $name:ident => $compute:block) => {
        fn $name<'tcx>(
            $tcx: TyCtxt<'tcx>,
            def_id_arg: crate::rustc_middle::queries::$name::Key<'tcx>,
        ) -> crate::rustc_middle::queries::$name::ProvidedValue<'tcx> {
            let _prof_timer =
            ...
            use crate::rustc_middle::dep_graph::DepKind;
...
pub(in crate::rustc_metadata::rmeta) fn provide(providers: &mut Providers) {
    ...
    providers.queries = crate::rustc_middle::query::Providers {
        ...
        dependency_formats: |tcx, ()| Arc::new(crate::rustc_metadata::dependency_format::calculate(tcx)),
