...
use crate::rustc_attr_parsing::eval_config_entry;
use crate::rustc_crate_store::{
...
use crate::rustc_target::spec::{Arch, BinaryFormat, CfgAbi};
...
impl<'tcx> Collector<'tcx> {
    fn process_module(&mut self, module: &ForeignModule) {
        ...
        for attr in find_attr!(self.tcx, def_id, Link(links, _) => links).into_iter().flatten() {
    ...
    fn build_dll_import(
        ...
        let size = match symbol_type {
            ...
            DllImportSymbolType::Function => crate::rustc_abi::Size::ZERO,
