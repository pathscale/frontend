...
pub use crate::rustc_ast::attr::data_structures::*;
pub use crate::rustc_ast::attr::version::RustcVersion;
use crate::rustc_ast::expand::autodiff_attrs::{DiffActivity, DiffMode};
use crate::rustc_ast::expand::typetree::TypeTree;
use crate::rustc_ast::token::DocFragmentKind;
use crate::rustc_ast::{AttrStyle, Path, ast};
...
use crate::rustc_structures::{CollapseMacroDebuginfo, CrateType, Limit, NativeLibKind, SanitizerSet};
use thin_vec::ThinVec;

pub use crate::rustc_attr_ir::canonical_symbols::{CanonicalSymbol, CanonicalSymbols};
...
impl IntoDiagArg for MirDialect {
    fn into_diag_arg(self, _path: &mut crate::rustc_error_messages::LongTyPath) -> DiagArgValue {
        let arg = match self {
...
impl<E: crate::rustc_span::SpanEncoder> crate::rustc_serialize::Encodable<E> for DocAttribute {
    fn encode(&self, encoder: &mut E) {
        ...
        crate::rustc_serialize::Encodable::<E>::encode(first_span, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(aliases, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(hidden, encoder);
        ...
        crate::rustc_serialize::Encodable::<E>::encode(&inline, encoder);

        crate::rustc_serialize::Encodable::<E>::encode(cfg, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(auto_cfg, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(auto_cfg_change, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(fake_variadic, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(keyword, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(attribute, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(masked, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(notable_trait, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(search_unbox, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(html_favicon_url, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(html_logo_url, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(html_playground_url, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(html_root_url, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(html_no_source, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(issue_tracker_base_url, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(rust_logo, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(test_attrs, encoder);
        crate::rustc_serialize::Encodable::<E>::encode(no_crate_inject, encoder);
    }
}
