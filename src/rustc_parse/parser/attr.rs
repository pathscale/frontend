...
use crate::rustc_ast::tokenstream::{ParserRange, WithTokens};
use crate::rustc_ast::{Attribute, attr};
use crate::rustc_errors::codes::*;
use crate::rustc_errors::{Diag, PResult, msg};
...
use crate::rustc_parse::parser::FnContext;
use crate::rustc_parse::{diagnostics, exp};
