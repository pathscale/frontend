...
use crate::rustc_errors::{Applicability, Diag, PResult, StashKey, Subdiagnostic};
use crate::rustc_lint_defs::builtin::BREAK_WITH_LABEL_AND_LOOP;
use rustc_literal_escaper::unescape_char;
use crate::rustc_session::diagnostics::report_lit_error;
use crate::rustc_span::edition::Edition;
use crate::rustc_span::{BytePos, ErrorGuaranteed, Ident, Pos, Span, Spanned, Symbol, kw, respan, sym};
...
use crate::rustc_parse::diagnostics::ExprParenthesesNeeded;
use crate::rustc_parse::{diagnostics, exp, maybe_recover_from_interpolated_ty_qpath};
    ...
    pub(crate) fn mk_closure_expr(&self, span: Span, body: Box<Expr>) -> Box<Expr> {
        self.mk_expr(
            ...
            ast::ExprKind::Closure(Box::new(ast::Closure {
                binder: crate::rustc_ast::ClosureBinder::NotPresent,
                constness: crate::rustc_ast::Const::No,
                movability: crate::rustc_ast::Movability::Movable,
                capture_clause: crate::rustc_ast::CaptureBy::Ref,
                coroutine_marker: None,
                fn_decl: Box::new(crate::rustc_ast::FnDecl {
                    inputs: Default::default(),
                    output: crate::rustc_ast::FnRetTy::Default(span),
                }),
                fn_arg_span: span,
                fn_decl_span: span,
                body,
