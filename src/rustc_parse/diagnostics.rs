...
use crate::rustc_ast::token::{self, InvisibleOrigin, MetaVarKind, Token};
...
pub(crate) enum InvalidComparisonOperatorSub {
    ...
    #[label("`<=>` is not a valid comparison operator, use `core::cmp::Ordering`")]
...
impl IntoDiagArg for Case {
    fn into_diag_arg(self, path: &mut crate::rustc_errors::LongTyPath) -> DiagArgValue {
        match self {
