...
use crate::rustc_errors::{Applicability, Diag, ErrorGuaranteed};
...
use crate::rustc_lint_defs::builtin::{TRIVIAL_CASTS, TRIVIAL_NUMERIC_CASTS};
...
use crate::rustc_trait_selection::traits::{self, ObligationCtxt, TraitEngine};
use tracing::{debug, instrument};

use super::FnCtxt;
use crate::rustc_hir_typeck::{diagnostics, type_error_struct};
...
pub fn check_cast<'tcx>(
    ...
    let root_ctxt = crate::rustc_hir_typeck::TypeckRootCtxt::new(tcx, local_def_id);
