...
use crate::rustc_trait_selection::solve::inspect::{self, InferCtxtProofTreeExt, ProofTreeVisitor};
use crate::rustc_trait_selection::solve::{Certainty, Goal, NoSolution};
...
use crate::rustc_hir_typeck::diagnostics::SuggestBoxingForReturnImplTrait;
...
pub fn can_coerce<'tcx>(
    ...
    let root_ctxt = crate::rustc_hir_typeck::typeck_root_ctxt::TypeckRootCtxt::new(tcx, body_def_id);
