...
use crate::rustc_hir_pretty::ty_to_string;
...
use crate::rustc_hir_typeck::{Diverges, Expectation, FnCtxt, GatherLocalsVisitor, Needs};
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    fn suggest_removing_semicolon_for_coerce(
        ...
        let sugg = crate::rustc_hir_typeck::diagnostics::RemoveSemiForCoerce { expr: expr.span, ret, semi };
