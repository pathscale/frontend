...
use crate::rustc_errors::{Applicability, Diag, ErrorGuaranteed, MultiSpan, a_or_an, listify, pluralize};
...
use crate::rustc_hir::{Expr, ExprKind, FnRetTy, HirId, Node, QPath, is_range_literal};
use crate::rustc_hir_analysis::check::potentially_plural_count;
use crate::rustc_hir_analysis::hir_ty_lowering::{HirTyLowerer, ResolvedStructPath};
...
use crate::rustc_middle::ty::{self, IsSuggestable, Ty, TyCtxt, TypeVisitableExt, Unnormalized};
...
use crate::rustc_hir_typeck::Expectation::*;
use crate::rustc_hir_typeck::TupleArgumentsFlag::*;
use crate::rustc_hir_typeck::callee::SplatLoweringInfo;
use crate::rustc_hir_typeck::coercion::CoerceMany;
use crate::rustc_hir_typeck::diagnostics::{ExprParenthesesNeeded, SuggestPtrNullMut};
use crate::rustc_hir_typeck::fn_ctxt::arg_matrix::{ArgMatrix, Compatibility, Error, ExpectedIdx, ProvidedIdx};
use crate::rustc_hir_typeck::gather_locals::Declaration;
use crate::rustc_hir_typeck::inline_asm::InlineAsmCtxt;
use crate::rustc_hir_typeck::method::probe::IsSuggestion;
use crate::rustc_hir_typeck::method::probe::Mode::MethodCall;
use crate::rustc_hir_typeck::method::probe::ProbeScope::TraitsInScope;
use crate::rustc_hir_typeck::{
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    pub(in super::super) fn check_casts(&mut self) {
        ...
        for cast in deferred_cast_checks.drain(..) {
            let body_def_id = core::mem::replace(&mut self.body_def_id, cast.body_def_id);
            cast.check(self);
        ...
        ] = &self.errors[..]
        {
                ...
                && provided_idx.as_usize() == expected_idx.as_usize()
            {
                self.note_source_of_type_mismatch_constraint(
                    &mut err,
                    rcvr,
                    crate::rustc_hir_typeck::demand::TypeMismatchSource::Arg {
