...
use crate::rustc_errors::{Applicability, Diag, DiagCtxtHandle, Diagnostic, Level};
use crate::rustc_hir::attrs::lang_items::LangItem;
use crate::rustc_hir::def::DefKind;
use crate::rustc_hir::{self as hir, ExprKind, HirId, Node, find_attr};
...
use crate::rustc_infer::traits::{ObligationCauseCode, PredicateObligation, query};
...
use crate::rustc_trait_selection::solve::Goal;
use crate::rustc_trait_selection::traits::query::CanonicalMethodAutoderefStepsGoal;
...
use crate::rustc_hir_typeck::FnCtxt;
...
impl<'a, 'tcx> ProbeContext<'a, 'tcx> {
    ...
    /// see [OpaqueTypesJank](crate::rustc_trait_selection::solve::OpaqueTypesJank).
    ///
    ...
    /// `crate::rustc_hir_analysis::hir_ty_lowering::HirTyLowerer::collapse_candidates_to_subtrait_pick`;
