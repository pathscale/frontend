...
use crate::rustc_ast::{self as ast, AssignOp, BinOp};
...
use crate::rustc_errors::{Applicability, Diag, struct_span_code_err};
use crate::rustc_hir::def_id::DefId;
use crate::rustc_hir::{self as hir, AssignOpKind, BinOpKind, Expr, ExprKind};
...
use crate::rustc_span::{Span, Spanned, Symbol, sym};
...
use crate::rustc_hir_typeck::diagnostics::ExprParenthesesNeeded;
use crate::rustc_hir_typeck::method::TreatNotYetDefinedOpaques;
use crate::rustc_hir_typeck::{Expectation, diagnostics};
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    /// to print the normal "implementation of `core::ops::Add` might be missing" note
