...
use crate::rustc_errors::{Applicability, Diag, DiagCtxtHandle, Diagnostic, Level, MultiSpan};
...
use crate::rustc_lint_defs::builtin::RUST_2021_INCOMPATIBLE_CLOSURE_CAPTURES;
...
use super::FnCtxt;
use crate::rustc_hir_typeck::expr_use_visitor as euv;
use crate::rustc_hir_typeck::expr_use_visitor::Delegate as _;
