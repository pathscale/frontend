...
use crate::rustc_middle::ty::layout::{HasTypingEnv, TyAndLayout};
use crate::rustc_middle::ty::print::with_no_trimmed_paths;
use crate::rustc_middle::ty::{self, Ty, TyCtxt, TypeVisitable};
...
use crate::rustc_const_eval::const_eval::CheckAlignment;
...
use crate::rustc_const_eval::{CTRL_C_RECEIVED, diagnostics};
...
pub fn eval_to_const_value_raw_provider<'tcx>(
    ...
    crate::rustc_const_eval::assert_typing_mode(key.typing_env.typing_mode());
...
fn report_validation_error<'tcx>(
    ...
    crate::rustc_const_eval::const_eval::report(ecx, error, move |diag, span, frames| {
