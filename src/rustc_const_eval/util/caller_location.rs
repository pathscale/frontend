...
use crate::rustc_const_eval::const_eval::{CanAccessMutGlobal, CompileTimeInterpCx, mk_eval_cx_to_read_const_val};
...
pub(crate) fn const_caller_location_provider(
    ...
    let mut ecx = mk_eval_cx_to_read_const_val(
        tcx,
        crate::rustc_span::DUMMY_SP, // This interpreter cannot fail, so the span is irrelevant.
