...
impl<T: Clone + Eq + Hash + core::fmt::Debug, PATH> RefTracking<T, PATH> {
    pub fn empty() -> Self {
...
impl<'tcx, T: Clone + Eq + Hash + core::fmt::Debug> RefTracking<T, Path<'tcx>> {
...
pub type RangeSet = crate::rustc_data_structures::range_set::RangeSet<Size>;
