...
use crate::rustc_middle::ty::{PolyExistentialPredicate, Ty, TyCtxt, TypeVisitable, TypeVisitableExt};
...
use crate::rustc_const_eval::const_eval::{CompileTimeInterpCx, CompileTimeMachine, InterpretationResult};
use crate::rustc_const_eval::interpret::Machine;
...
pub(crate) fn type_implements_dyn_trait<'tcx, M: Machine<'tcx>>(
    ...
    ocx.register_obligations(preds.iter().map(|pred: PolyExistentialPredicate<'_>| {
        ...
        let pred = crate::rustc_middle::ty::fold_regions(ecx.tcx.tcx, pred, |r, _| {
...
/// A marker trait returned by [crate::rustc_const_eval::interpret::Machine::enter_trace_span], identifying either a
...
/// Shorthand for calling [crate::rustc_const_eval::interpret::Machine::enter_trace_span] on a [tracing::info_span!].
/// This is supposed to be compiled out when [crate::rustc_const_eval::interpret::Machine::enter_trace_span] has the
/// default implementation (i.e. when it does not actually enter the span but instead returns `()`).
/// This macro takes a type implementing the [crate::rustc_const_eval::interpret::Machine] trait as its first argument
...
///
/// [crate::rustc_const_eval::interpret::Machine::enter_trace_span] returns [EnteredTraceSpan], on which you can call
...
macro_rules! enter_trace_span {
    ...
    ($machine:ty, $($tt:tt)*) => {
        <$machine as $crate::rustc_const_eval::interpret::Machine>::enter_trace_span(|| tracing::info_span!($($tt)*))
    };
}
