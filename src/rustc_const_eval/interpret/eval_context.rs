...
use crate::rustc_const_eval::{enter_trace_span, util};
...
pub struct InterpCx<'tcx, M: Machine<'tcx>> {
    ...
    pub(super) layout_cache: RefCell<FxHashMap<Ty<'tcx>, crate::rustc_abi::Layout<'tcx>>>,
...
impl<'tcx, M: Machine<'tcx>> InterpCx<'tcx, M> {
    pub fn new(
        ...
        crate::rustc_const_eval::assert_typing_mode(typing_env.typing_mode());
