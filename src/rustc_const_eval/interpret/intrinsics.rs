...
use crate::rustc_const_eval::interpret::{MPlaceTy, Writeable};
...
pub(crate) fn alloc_type_name<'tcx>(tcx: TyCtxt<'tcx>, ty: Ty<'tcx>) -> (AllocId, u64) {
    let path = crate::rustc_const_eval::util::type_name(tcx, ty);
...
impl<'tcx, M: Machine<'tcx>> InterpCx<'tcx, M> {
    ...
    pub fn eval_intrinsic(
        ...
        match intrinsic_name {
            ...
            sym::va_copy => {
                ...
                let zeros = core::iter::repeat_n(0u8, dest.layout.size.bytes_usize());
    ...
    /// - `T` is a pointer to [`alloc::ffi::c_void`] and `U` is a pointer to [`i8`] or [`u8`],
    /// or vice versa.
    ...
    pub fn write_bytes_intrinsic(
        ...
        let bytes = core::iter::repeat_n(byte, len.bytes_usize());
