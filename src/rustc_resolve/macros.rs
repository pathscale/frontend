...
use crate::rustc_errors::{Applicability, StashKey};
...
use crate::rustc_hir::def::{DefKind, MacroKinds, Namespace, NonMacroAttrKind};
use crate::rustc_hir::def_id::{CrateNum, DefId, LocalDefId};
use crate::rustc_hir::{Attribute, StabilityLevel};
...
use crate::rustc_resolve::Namespace::*;
use crate::rustc_resolve::def_collector::collect_definitions;
