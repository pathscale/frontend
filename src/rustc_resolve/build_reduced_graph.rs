...
use crate::rustc_expand::base::{ResolverExpand, SyntaxExtension, SyntaxExtensionKind};
...
use crate::rustc_middle::ty::{TyCtxtFeed, Visibility};
use crate::rustc_middle::{bug, span_bug};
use crate::rustc_span::def_id::{CRATE_MOD_ID, ModId};
use crate::rustc_span::hygiene::{ExpnId, LocalExpnId, MacroKind};
use crate::rustc_span::{Ident, Span, Symbol, kw, sym};
use thin_vec::ThinVec;
use tracing::debug;

use crate::rustc_resolve::Namespace::{MacroNS, TypeNS, ValueNS};
...
use crate::rustc_resolve::ref_mut::CmCell;
