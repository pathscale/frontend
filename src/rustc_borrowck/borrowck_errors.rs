...
use crate::rustc_errors::{Applicability, Diag, DiagCtxtHandle, struct_span_code_err};
use crate::rustc_hir as hir;
use crate::span_bug;
use crate::rustc_middle::ty::{self, Ty};
use crate::rustc_span::Span;

impl<'diag, 'tcx> crate::rustc_borrowck::MirBorrowckCtxt<'_, 'diag, 'tcx> {
    ...
    pub(crate) fn cannot_move_when_borrowed(
        ...
        self.dcx().create_err(crate::rustc_borrowck::session_diagnostics::MoveBorrow {
            place,
            span,
            borrow_place,
            value_place,
