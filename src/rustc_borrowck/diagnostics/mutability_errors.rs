...
use crate::rustc_hir::{self as hir, BindingMode, ByRef, Expr, Node};
use crate::bug;
...
use crate::rustc_borrowck::diagnostics::BorrowedContentSource;
use crate::rustc_borrowck::{MirBorrowckCtxt, session_diagnostics};
    ...
    fn suggest_map_index_mut_alternatives(&self, ty: Ty<'tcx>, err: &mut Diag<'_>, span: Span) {
            ...
            || self.infcx.tcx.is_diagnostic_item(sym::BTreeMap, did)
        {
            ...
            struct SuggestIndexOperatorAlternativeVisitor<'a, 'diag, 'tcx> {
                ...
                ty: Ty<'tcx>,
                suggested: bool,
                infcx: &'a crate::rustc_infer::infer::InferCtxt<'tcx>,
            }
...
fn suggest_ampmut<'tcx>(
    infcx: &crate::rustc_borrowck::BorrowckInferCtxt<'tcx>,
    body: &Body<'tcx>,
...
fn suggest_ref_mut(tcx: TyCtxt<'_>, span: Span) -> Option<Span> {
    ...
    if let Some(rest) = pattern_str.strip_prefix("ref")
        && rest.starts_with(crate::rustc_lexer::is_whitespace)
    {
