...
use crate::rustc_borrowck::BorrowckInferCtxt;
use crate::rustc_borrowck::constraints::ConstraintSccIndex;
use crate::rustc_borrowck::handle_placeholders::{SccAnnotations, region_definitions};
use crate::rustc_borrowck::region_infer::reverse_sccs::ReverseSccGraph;
use crate::rustc_borrowck::region_infer::values::RegionValues;
use crate::rustc_borrowck::region_infer::{
...
/// A slimmed down version of [crate::rustc_borrowck::region_infer::RegionInferenceContext] used
...
impl<'a, 'tcx> RegionCtxt<'a, 'tcx> {
    ...
    pub(super) fn new(
        ...
        let added_constraints = crate::rustc_borrowck::handle_placeholders::rewrite_placeholder_outlives(
            &constraint_sccs,
            &scc_annotations,
