...
use crate::rustc_borrowck::consumers::BorrowckConsumer;
use crate::rustc_borrowck::diagnostics::BorrowckDiagnosticsBuffer;
use crate::rustc_borrowck::nll::compute_closure_requirements_modulo_opaques;
use crate::rustc_borrowck::region_infer::opaque_types::{
...
use crate::rustc_borrowck::type_check::{Locations, constraint_conversion};
...
pub(super) struct BorrowCheckRootCtxt<'diag, 'tcx: 'diag> {
    ...
    /// [`crate::rustc_borrowck::region_infer::opaque_types::handle_unconstrained_hidden_type_errors`]
    ...
    /// This should be `None` during normal compilation. See [`crate::rustc_borrowck::consumers`] for more
