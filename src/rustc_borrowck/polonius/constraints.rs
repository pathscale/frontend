...
use crate::rustc_borrowck::BorrowSet;
use crate::rustc_borrowck::constraints::OutlivesConstraint;
use crate::rustc_borrowck::dataflow::BorrowIndex;
use crate::rustc_borrowck::polonius::ConstraintDirection;
use crate::rustc_borrowck::region_infer::values::LivenessValues;
...
///   variance.
///
/// This dual of NLL's [crate::rustc_borrowck::constraints::OutlivesConstraint] therefore encodes the
