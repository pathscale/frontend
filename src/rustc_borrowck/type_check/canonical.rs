...
use crate::rustc_middle::ty::{self, Ty, TyCtxt, TypeFoldable, Unnormalized, Upcast};
...
use crate::rustc_borrowck::diagnostics::ToUniverseInfo;
use crate::rustc_borrowck::type_check::{MirTypeckRegionConstraints, constraint_conversion};
...
impl<'a, 'tcx> TypeChecker<'a, 'tcx> {
    ...
    pub(super) fn prove_clauses(
        &mut self,
        clauses: impl IntoIterator<Item: Upcast<TyCtxt<'tcx>, ty::Clause<'tcx>> + core::fmt::Debug>,
        locations: Locations,
        category: ConstraintCategory<'tcx>,
    ) {
    ...
    pub(super) fn prove_clause(
        &mut self,
        clause: impl Upcast<TyCtxt<'tcx>, ty::Clause<'tcx>> + core::fmt::Debug,
        locations: Locations,
        category: ConstraintCategory<'tcx>,
    ) {
