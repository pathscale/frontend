...
use crate::rustc_data_structures::stable_hash::RawSpan;
// This code is very hot and uses lots of arithmetic, avoid overflow checks for performance.
// See https://github.com/rust-lang/rust/pull/119440#issuecomment-1874255727
use crate::rustc_serialize::int_overflow::DebugStrictAdd;

use crate::rustc_span::def_id::{DefIndex, LocalDefId};
use crate::rustc_span::hygiene::SyntaxContext;
use crate::rustc_span::{BytePos, SPAN_TRACK, SpanData};
...
fn with_span_interner<T, F: FnOnce(&mut SpanInterner) -> T>(f: F) -> T {
    crate::rustc_span::with_session_globals(|session_globals| f(&mut session_globals.span_interner.lock()))
}
