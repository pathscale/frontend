...
use crate::rustc_span::def_id::{CRATE_DEF_ID, CrateNum, DefId, LOCAL_CRATE, ModId, StableCrateId};
use crate::rustc_span::edition::Edition;
use crate::rustc_span::source_map::SourceMap;
use crate::rustc_span::symbol::{Symbol, kw, sym};
use crate::rustc_span::{DUMMY_SP, Span, SpanDecoder, SpanEncoder, with_session_globals};
...
pub struct ExpnData {
    ...
    /// Enables the macro helper hack (`ident!(...)` -> `$crate::rustc_span::ident!(...)`) for this macro.
