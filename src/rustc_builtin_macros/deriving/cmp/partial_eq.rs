...
use crate::rustc_ast::{BinOpKind, BorrowKind, Expr, ExprKind, MetaItem, Mutability, Safety};
use crate::rustc_expand::base::{Annotatable, ExtCtxt};
use crate::rustc_span::{Span, sym};
use thin_vec::thin_vec;

use crate::rustc_builtin_macros::deriving::generic::ty::*;
use crate::rustc_builtin_macros::deriving::generic::{self, *};
