...
use crate::rustc_lint_defs::builtin::BAD_ASM_STYLE;
use crate::rustc_parse::parser::asm::*;
use crate::rustc_parse_format as parse;
...
use crate::rustc_builtin_macros::util::{ExprToSpannedString, expr_to_spanned_string};
...
fn expand_preparsed_asm(
    ...
    for (i, template_expr) in args.templates.into_iter().enumerate() {
        ...
        let span_in_template = |range: core::ops::Range<usize>| -> Span {
        ...
        if args.options.contains(ast::InlineAsmOptions::RAW) {
            ...
            line_spans.extend(core::iter::repeat_n(template_sp, template_num_lines));
            continue;
        }
