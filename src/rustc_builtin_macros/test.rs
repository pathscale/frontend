...
use crate::rustc_errors::{Applicability, Diag, Level};
use crate::rustc_expand::base::*;
use crate::rustc_span::{ErrorGuaranteed, Ident, RemapPathScopeComponents, Span, Symbol, sym};
use thin_vec::{ThinVec, thin_vec};
use tracing::debug;

use crate::rustc_builtin_macros::diagnostics;
use crate::rustc_builtin_macros::util::{check_builtin_macro_attribute, warn_on_duplicate_attribute};
