...
//! For that see [`crate::rustc_parse::lexer`], which converts this basic token stream
...
//! lexeme types.
//!
//! [`crate::rustc_parse::lexer`]: ../rustc_parse/lexer/index.html
...
impl<'a> Cursor<'a> {
    ...
    fn frontmatter(&mut self, has_invalid_preceding_whitespace: bool) -> TokenKind {
        ...
        let mut found = false;
        let nl_fence_pattern = alloc::format!("\n{:-<1$}", "", length_opening as usize);
    ...
    ///
    /// Used by `crate::rustc_parse::lexer` to lex for guarded strings
