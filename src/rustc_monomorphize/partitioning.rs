...
use crate::rustc_middle::ty::{self, InstanceKind, ShimKind, TyCtxt};
...
use crate::rustc_monomorphize::collector::{self, MonoItemCollectionStrategy, UsageMap};
use crate::rustc_monomorphize::diagnostics::SymbolAlreadyDefined;
use crate::rustc_monomorphize::graph_checks::target_specific_checks;
...
fn merge_codegen_units<'tcx>(
    ...
    if cx.tcx.sess.opts.incremental.is_some() {
        ...
        for cgu in codegen_units.iter_mut() {
            ...
            cgu.set_symbol_name(Symbol::intern(&crate::rustc_symbol_mangling::mangle_cgu(
                cx.tcx,
                LOCAL_CRATE,
